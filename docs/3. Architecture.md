# Codalab Competitions architecture
...
![RabbitMQ Management](../codalab/apps/web/static/img/monitoring_tool_rabbitmgmt.png)
&mdash; RabbitMQ Management

![Flower](../codalab/apps/web/static/img/monitoring_tool_flower.png)
&mdash; Flower
