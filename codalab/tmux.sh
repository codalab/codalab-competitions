...
tmux send-keys -t codalab_workers "celery -A codalab worker -l info -Q site-worker" ENTER
...
tmux send-keys -t codalab_workers "celery -A codalab worker -l info -Q compute-worker --concurrency=1" ENTER
