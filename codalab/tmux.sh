...
tmux send-keys -t codalab_workers "celery -A codalab worker -l info -Q site-worker -n site-worker -Ofast" ENTER
...
tmux send-keys -t codalab_workers "celery -A codalab worker -l info -Q compute-worker -n compute-worker --concurrency=1" ENTER
