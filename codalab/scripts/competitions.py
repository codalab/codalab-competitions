...
brats2012.save()
Page.objects.create(category=details_category, container=pc, label="Overview", rank=0, 
                    html=open(os.path.join(os.path.dirname(__file__), "brats2012_overview.html")).read())
Page.objects.create(category=details_category, container=pc, label="Evaluation", rank=1, 
                    html=open(os.path.join(os.path.dirname(__file__), "brats2012_evaluation.html")).read())
Page.objects.create(category=details_category, container=pc, label="Terms and Conditions", 
                    rank=2, html=open(os.path.join(os.path.dirname(__file__), "brats2012_terms_and_conditions.html")).read())
Page.objects.create(category=details_category, container=pc, label="FAQ", rank=3, 
                    html=open(os.path.join(os.path.dirname(__file__), "brats2012_faq.html")).read())
Page.objects.create(category=details_category, container=pc, label="Key Dates", rank=4, 
                    html=open(os.path.join(os.path.dirname(__file__), "brats2012_key_dates.html")).read())
Page.objects.create(category=details_category, container=pc, label="Organizers", rank=5, 
