...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'newsletter_newsletteruser', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authenz.ClUser'], null=True))

    def backwards(self, orm):

        # Changing field 'NewsletterUser.user'
        db.alter_column(u'newsletter_newsletteruser', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['authenz.ClUser']))
    ...
    models = {
        ...
        u'newsletter.newsletteruser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['authenz.ClUser']", 'null': 'True', 'blank': 'True'})
        }
    }
