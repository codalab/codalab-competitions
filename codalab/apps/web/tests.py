...
class CompetitionPhaseTests(TestCase):
    ...
    def test_rank_values_2(self):
        ...
        input = {}
        expected = {"a": 1, "b" : 1, "d" : 1, "f" : 1, "e" : 1 } 
        self.validate(ids, expected, CompetitionPhase.rank_values(ids, input, sort_ascending=False))
    ...
    def test_rank_values_8(self):
        ...
        input = {"e": 1.0, "a":1.001}
        expected = {"a": 1, "b" : 2, "d" : 2, "f" : 2, "e" : 1 } 
        self.validate(ids, expected, CompetitionPhase.rank_values(ids, input, sort_ascending=False, eps=0.01))

    def test_rank_values_9(self):
        ids = {"a", "b", "d", "f", "e"}
        input = {"e": 1.0, "a":1.001}
        expected = {"a": 1, "b" : 2, "d" : 2, "f" : 2, "e" : 1 } 
        self.validate(ids, expected, CompetitionPhase.rank_values(ids, input, sort_ascending=True, eps=0.01))

    def test_rank_values_10(self):
        ids = {"a", "b", "d", "f", "e"}
        input = {"e": 1.0, "a": 1.001}
        expected = {"a": 2, "b" : 3, "d" : 3, "f" : 3, "e" : 1 } 
        self.validate(ids, expected, CompetitionPhase.rank_values(ids, input, sort_ascending=True))
    ...
    def test_format_values(self):
        ...
        self.assertEqual("0.1283495600", CompetitionPhase.format_value(x, "20"))
