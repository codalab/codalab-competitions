...
# from apps.web.models import Competition, CompetitionPhase, CompetitionParticipant, ExternalFile, ExternalFileType, \
#     ParticipantStatus
#
...
#         assert False, "This depended on CompetitionDataset which no longer exists?"
#
