...
class CompetitionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
                   'description' : forms.Textarea(attrs={'rows' : 20, 'class' : 'competition-editor-description'})
                   }
class CompetitionPhaseForm(forms.ModelForm):
    class Meta:
        model = models.CompetitionPhase
        fields = ('label', 'start_date', 'max_submissions', 'scoring_program', 'reference_data')
...
class PageForm(forms.ModelForm):
    class Meta:
        ...
        fields = ('html',)
        widgets = {
                   'html' : forms.Textarea(attrs={'rows' : 20, 'class' : 'competition-editor-page-html' })
                   }
