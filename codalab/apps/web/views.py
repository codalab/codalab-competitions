...
class CompetitionUpload(LoginRequiredMixin, CreateView, CompetitionCreationMixin):
    model = models.CompetitionDefBundle
    template_name = 'web/competitions/upload_competition.html'


class CompetitionS3Upload(LoginRequiredMixin, FormView, CompetitionCreationMixin):
