...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field admins on 'Competition'
        m2m_table_name = db.shorten_name(u'web_competition_admins')
        ...
        db.create_unique(m2m_table_name, ['competition_id', 'cluser_id'])


    def backwards(self, orm):
        # Removing M2M table for field admins on 'Competition'
        db.delete_table(db.shorten_name(u'web_competition_admins'))
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'admins': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'competition_admins'", 'symmetrical': 'False', 'to': u"orm['authenz.ClUser']"}),
