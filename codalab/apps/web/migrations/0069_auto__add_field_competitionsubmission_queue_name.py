...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.queue_name'
        db.add_column(u'web_competitionsubmission', 'queue_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.queue_name'
        db.delete_column(u'web_competitionsubmission', 'queue_name')
