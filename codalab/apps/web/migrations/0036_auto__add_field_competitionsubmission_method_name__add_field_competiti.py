...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.method_name'
        db.add_column(u'web_competitionsubmission', 'method_name',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.method_description'
        db.add_column(u'web_competitionsubmission', 'method_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Competition.enable_per_submission_metadata'
        db.add_column(u'web_competition', 'enable_per_submission_metadata',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.method_name'
        db.delete_column(u'web_competitionsubmission', 'method_name')

        # Deleting field 'CompetitionSubmission.method_description'
        db.delete_column(u'web_competitionsubmission', 'method_description')

        # Deleting field 'Competition.enable_per_submission_metadata'
        db.delete_column(u'web_competition', 'enable_per_submission_metadata')
