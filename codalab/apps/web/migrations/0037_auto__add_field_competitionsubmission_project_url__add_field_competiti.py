...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.project_url'
        db.add_column(u'web_competitionsubmission', 'project_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.publication_url'
        db.add_column(u'web_competitionsubmission', 'publication_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.bibtex'
        db.add_column(u'web_competitionsubmission', 'bibtex',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.project_url'
        db.delete_column(u'web_competitionsubmission', 'project_url')

        # Deleting field 'CompetitionSubmission.publication_url'
        db.delete_column(u'web_competitionsubmission', 'publication_url')

        # Deleting field 'CompetitionSubmission.bibtex'
        db.delete_column(u'web_competitionsubmission', 'bibtex')
