...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CompetitionSubmissionMetadata', fields ['submission']
        db.delete_unique(u'web_competitionsubmissionmetadata', ['submission_id'])

        # Adding field 'CompetitionSubmissionMetadata.is_predict'
        db.add_column(u'web_competitionsubmissionmetadata', 'is_predict',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CompetitionSubmissionMetadata.is_scoring'
        db.add_column(u'web_competitionsubmissionmetadata', 'is_scoring',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CompetitionSubmissionMetadata.submission'
        db.alter_column(u'web_competitionsubmissionmetadata', 'submission_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.CompetitionSubmission']))

    def backwards(self, orm):
        # Deleting field 'CompetitionSubmissionMetadata.is_predict'
        db.delete_column(u'web_competitionsubmissionmetadata', 'is_predict')

        # Deleting field 'CompetitionSubmissionMetadata.is_scoring'
        db.delete_column(u'web_competitionsubmissionmetadata', 'is_scoring')


        # Changing field 'CompetitionSubmissionMetadata.submission'
        db.alter_column(u'web_competitionsubmissionmetadata', 'submission_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['web.CompetitionSubmission']))
        # Adding unique constraint on 'CompetitionSubmissionMetadata', fields ['submission']
        db.create_unique(u'web_competitionsubmissionmetadata', ['submission_id'])
