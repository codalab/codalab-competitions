...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.started_at'
        db.add_column(u'web_competitionsubmission', 'started_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.completed_at'
        db.add_column(u'web_competitionsubmission', 'completed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.coopetition_file'
        db.add_column(u'web_competitionsubmission', 'coopetition_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.when_made_public'
        db.add_column(u'web_competitionsubmission', 'when_made_public',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.when_unmade_public'
        db.add_column(u'web_competitionsubmission', 'when_unmade_public',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.download_count'
        db.add_column(u'web_competitionsubmission', 'download_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.like_count'
        db.add_column(u'web_competitionsubmission', 'like_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.dislike_count'
        db.add_column(u'web_competitionsubmission', 'dislike_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.started_at'
        db.delete_column(u'web_competitionsubmission', 'started_at')

        # Deleting field 'CompetitionSubmission.completed_at'
        db.delete_column(u'web_competitionsubmission', 'completed_at')

        # Deleting field 'CompetitionSubmission.coopetition_file'
        db.delete_column(u'web_competitionsubmission', 'coopetition_file')

        # Deleting field 'CompetitionSubmission.when_made_public'
        db.delete_column(u'web_competitionsubmission', 'when_made_public')

        # Deleting field 'CompetitionSubmission.when_unmade_public'
        db.delete_column(u'web_competitionsubmission', 'when_unmade_public')

        # Deleting field 'CompetitionSubmission.download_count'
        db.delete_column(u'web_competitionsubmission', 'download_count')

        # Deleting field 'CompetitionSubmission.like_count'
        db.delete_column(u'web_competitionsubmission', 'like_count')

        # Deleting field 'CompetitionSubmission.dislike_count'
        db.delete_column(u'web_competitionsubmission', 'dislike_count')
