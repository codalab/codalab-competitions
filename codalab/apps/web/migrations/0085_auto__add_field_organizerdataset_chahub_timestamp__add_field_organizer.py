...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizerDataSet.chahub_timestamp'
        db.add_column(u'web_organizerdataset', 'chahub_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrganizerDataSet.chahub_data_hash'
        db.add_column(u'web_organizerdataset', 'chahub_data_hash',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrganizerDataSet.chahub_needs_retry'
        db.add_column(u'web_organizerdataset', 'chahub_needs_retry',
    ...
    def backwards(self, orm):
        # Deleting field 'OrganizerDataSet.chahub_timestamp'
        db.delete_column(u'web_organizerdataset', 'chahub_timestamp')

        # Deleting field 'OrganizerDataSet.chahub_data_hash'
        db.delete_column(u'web_organizerdataset', 'chahub_data_hash')
