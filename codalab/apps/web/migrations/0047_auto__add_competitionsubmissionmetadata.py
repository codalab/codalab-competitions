...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_competitionsubmissionmetadata', (
            ...
            ('beginning_swap_memory_usage', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('beginning_cpu_usage', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('end_virtual_memory_usage', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('end_swap_memory_usage', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('end_cpu_usage', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['CompetitionSubmissionMetadata'])


    def backwards(self, orm):
        # Deleting model 'CompetitionSubmissionMetadata'
        db.delete_table(u'web_competitionsubmissionmetadata')
