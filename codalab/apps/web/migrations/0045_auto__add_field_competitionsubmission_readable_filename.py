...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.readable_filename'
        db.add_column(u'web_competitionsubmission', 'readable_filename',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.readable_filename'
        db.delete_column(u'web_competitionsubmission', 'readable_filename')
