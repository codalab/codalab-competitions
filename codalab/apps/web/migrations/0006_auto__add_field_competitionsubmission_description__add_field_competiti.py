...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompetitionPhase.leaderboard_submission_mode'
        db.add_column(u'web_competitionphase', 'leaderboard_submission_mode',
                      self.gf('django.db.models.fields.CharField')(default='manual', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CompetitionPhase.leaderboard_submission_mode'
        db.delete_column(u'web_competitionphase', 'leaderboard_submission_mode')
    ...
    models = {
        ...
        u'web.competitionphase': {
            ...
            'leaderboard_submission_mode': ('django.db.models.fields.CharField', [], {'default': "'manual'", 'max_length': '50'}),
