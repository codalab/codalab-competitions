...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.s3_file'
        db.add_column(u'web_competitionsubmission', 's3_file',
                      self.gf('s3direct.fields.S3DirectField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.s3_file'
        db.delete_column(u'web_competitionsubmission', 's3_file')
