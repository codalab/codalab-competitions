...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.ingestion_program_stdout_file'
        db.add_column(u'web_competitionsubmission', 'ingestion_program_stdout_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.ingestion_program_stderr_file'
        db.add_column(u'web_competitionsubmission', 'ingestion_program_stderr_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.ingestion_program_stdout_file'
        db.delete_column(u'web_competitionsubmission', 'ingestion_program_stdout_file')

        # Deleting field 'CompetitionSubmission.ingestion_program_stderr_file'
        db.delete_column(u'web_competitionsubmission', 'ingestion_program_stderr_file')
