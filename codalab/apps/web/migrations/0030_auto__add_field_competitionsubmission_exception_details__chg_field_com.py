...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.exception_details'
        db.add_column(u'web_competitionsubmission', 'exception_details',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Competition.original_yaml_file'
        db.alter_column(u'web_competition', 'original_yaml_file', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.exception_details'
        db.delete_column(u'web_competitionsubmission', 'exception_details')


        # Changing field 'Competition.original_yaml_file'
        db.alter_column(u'web_competition', 'original_yaml_file', self.gf('django.db.models.fields.TextField')(default=''))
