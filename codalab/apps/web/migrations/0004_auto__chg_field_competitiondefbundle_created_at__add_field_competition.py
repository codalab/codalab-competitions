...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompetitionDefBundle.created_at'
        db.alter_column(u'web_competitiondefbundle', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'CompetitionSubmission.prediction_runfile'
        db.add_column(u'web_competitionsubmission', 'prediction_runfile',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.prediction_output_file'
        db.add_column(u'web_competitionsubmission', 'prediction_output_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CompetitionDefBundle.created_at'
        db.alter_column(u'web_competitiondefbundle', 'created_at', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'CompetitionSubmission.prediction_runfile'
        db.delete_column(u'web_competitionsubmission', 'prediction_runfile')

        # Deleting field 'CompetitionSubmission.prediction_output_file'
        db.delete_column(u'web_competitionsubmission', 'prediction_output_file')
