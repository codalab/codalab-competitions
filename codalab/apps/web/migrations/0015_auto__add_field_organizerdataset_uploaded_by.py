...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizerDataSet.uploaded_by'
        db.add_column(u'web_organizerdataset', 'uploaded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['authenz.ClUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizerDataSet.uploaded_by'
        db.delete_column(u'web_organizerdataset', 'uploaded_by_id')
