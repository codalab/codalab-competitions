...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizerDataSet.key'
        db.add_column(u'web_organizerdataset', 'key',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizerDataSet.key'
        db.delete_column(u'web_organizerdataset', 'key')
