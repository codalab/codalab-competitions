...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.reverse_leaderboard_sorting'
        db.add_column(u'web_competition', 'reverse_leaderboard_sorting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.reverse_leaderboard_sorting'
        db.delete_column(u'web_competition', 'reverse_leaderboard_sorting')
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'reverse_leaderboard_sorting': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
