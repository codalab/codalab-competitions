...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.organization_logo'
        db.add_column(u'web_competition', 'organization_logo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.organization_logo'
        db.delete_column(u'web_competition', 'organization_logo')
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'organization_logo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
