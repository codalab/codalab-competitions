...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Competition.queue'
        db.alter_column(u'web_competition', 'queue_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['queues.Queue']))

    def backwards(self, orm):

        # Changing field 'Competition.queue'
        db.alter_column(u'web_competition', 'queue_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['queues.Queue']))
