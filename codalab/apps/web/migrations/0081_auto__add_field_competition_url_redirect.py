...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.url_redirect'
        db.add_column(u'web_competition', 'url_redirect',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.url_redirect'
        db.delete_column(u'web_competition', 'url_redirect')
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'url_redirect': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
