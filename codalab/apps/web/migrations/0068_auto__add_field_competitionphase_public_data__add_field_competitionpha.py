...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionPhase.public_data'
        db.add_column(u'web_competitionphase', 'public_data',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionPhase.public_data_organizer_dataset'
        db.add_column(u'web_competitionphase', 'public_data_organizer_dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='public_data_organizer_dataset', null=True, on_delete=models.SET_NULL, to=orm['web.OrganizerDataSet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionPhase.public_data'
        db.delete_column(u'web_competitionphase', 'public_data')

        # Deleting field 'CompetitionPhase.public_data_organizer_dataset'
        db.delete_column(u'web_competitionphase', 'public_data_organizer_dataset_id')
