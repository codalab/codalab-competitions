...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionPhase.force_best_submission_to_leaderboard'
        db.add_column(u'web_competitionphase', 'force_best_submission_to_leaderboard',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionPhase.force_best_submission_to_leaderboard'
        db.delete_column(u'web_competitionphase', 'force_best_submission_to_leaderboard')
