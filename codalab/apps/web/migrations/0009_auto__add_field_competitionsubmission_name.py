...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.name'
        db.add_column(u'web_competitionsubmission', 'name',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.name'
        db.delete_column(u'web_competitionsubmission', 'name')
    ...
    models = {
        ...
        u'web.competitionsubmission': {
            ...
            'name': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '40', 'blank': 'True'}),
