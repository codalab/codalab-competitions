...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.organization_or_affiliation'
        db.add_column(u'web_competitionsubmission', 'organization_or_affiliation',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.team_name'
        db.add_column(u'web_competitionsubmission', 'team_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.organization_or_affiliation'
        db.delete_column(u'web_competitionsubmission', 'organization_or_affiliation')

        # Deleting field 'CompetitionSubmission.team_name'
        db.delete_column(u'web_competitionsubmission', 'team_name')
