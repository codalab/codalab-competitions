...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.chahub_timestamp'
        db.add_column(u'web_competitionsubmission', 'chahub_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.chahub_data_hash'
        db.add_column(u'web_competitionsubmission', 'chahub_data_hash',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionSubmission.chahub_needs_retry'
        db.add_column(u'web_competitionsubmission', 'chahub_needs_retry',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.chahub_timestamp'
        db.delete_column(u'web_competitionsubmission', 'chahub_timestamp')

        # Deleting field 'CompetitionSubmission.chahub_data_hash'
        db.delete_column(u'web_competitionsubmission', 'chahub_data_hash')

        # Deleting field 'CompetitionSubmission.chahub_needs_retry'
        db.delete_column(u'web_competitionsubmission', 'chahub_needs_retry')
