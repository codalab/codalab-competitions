...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.hide_top_three'
        db.add_column(u'web_competition', 'hide_top_three',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Competition.hide_chart'
        db.add_column(u'web_competition', 'hide_chart',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.hide_top_three'
        db.delete_column(u'web_competition', 'hide_top_three')

        # Deleting field 'Competition.hide_chart'
        db.delete_column(u'web_competition', 'hide_chart')
