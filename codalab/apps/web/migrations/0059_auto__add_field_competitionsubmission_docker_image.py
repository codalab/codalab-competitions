...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.docker_image'
        db.add_column(u'web_competitionsubmission', 'docker_image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.docker_image'
        db.delete_column(u'web_competitionsubmission', 'docker_image')
