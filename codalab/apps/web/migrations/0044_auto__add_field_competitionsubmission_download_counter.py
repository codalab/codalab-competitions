...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.download_counter'
        db.add_column(u'web_competitionsubmission', 'download_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.download_counter'
        db.delete_column(u'web_competitionsubmission', 'download_counter')
    ...
    models = {
        ...
        u'web.competitionsubmission': {
            ...
            'download_counter': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
