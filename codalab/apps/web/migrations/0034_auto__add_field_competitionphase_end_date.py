...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionPhase.end_date'
        db.add_column(u'web_competitionphase', 'end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionPhase.end_date'
        db.delete_column(u'web_competitionphase', 'end_date')
