...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.is_migrating_delayed'
        db.add_column(u'web_competition', 'is_migrating_delayed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.is_migrating_delayed'
        db.delete_column(u'web_competition', 'is_migrating_delayed')
