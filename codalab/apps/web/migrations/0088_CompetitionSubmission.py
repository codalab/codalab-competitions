...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.sub_size'
        db.add_column(u'web_competitionsubmission', 'sub_size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.sub_size'
        db.delete_column(u'web_competitionsubmission', 'sub_size')
