...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionScoreDef.ordering'
        db.add_column(u'web_submissionscoredef', 'ordering',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'SubmissionScoreSet.ordering'
        db.add_column(u'web_submissionscoreset', 'ordering',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionScoreDef.ordering'
        db.delete_column(u'web_submissionscoredef', 'ordering')

        # Deleting field 'SubmissionScoreSet.ordering'
        db.delete_column(u'web_submissionscoreset', 'ordering')
