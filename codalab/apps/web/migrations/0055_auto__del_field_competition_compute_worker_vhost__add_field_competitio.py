...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.queue'
        db.add_column(u'web_competition', 'queue',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='competitions', null=True, to=orm['queues.Queue']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Competition.queue'
        db.delete_column(u'web_competition', 'queue_id')
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'queue': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'competitions'", 'null': 'True', 'to': u"orm['queues.Queue']"}),
