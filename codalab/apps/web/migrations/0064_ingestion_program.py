...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionPhase.ingestion_program'
        db.add_column(u'web_competitionphase', 'ingestion_program',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetitionPhase.ingestion_program_docker_image'
        db.add_column(u'web_competitionphase', 'ingestion_program_docker_image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionPhase.ingestion_program'
        db.delete_column(u'web_competitionphase', 'ingestion_program')

        # Deleting field 'CompetitionPhase.ingestion_program_docker_image'
        db.delete_column(u'web_competitionphase', 'ingestion_program_docker_image')
