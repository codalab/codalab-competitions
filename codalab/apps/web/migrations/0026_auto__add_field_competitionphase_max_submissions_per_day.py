...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionPhase.max_submissions_per_day'
        db.add_column(u'web_competitionphase', 'max_submissions_per_day',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionPhase.max_submissions_per_day'
        db.delete_column(u'web_competitionphase', 'max_submissions_per_day')
    ...
    models = {
        ...
        u'web.competitionphase': {
            ...
            'max_submissions_per_day': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
