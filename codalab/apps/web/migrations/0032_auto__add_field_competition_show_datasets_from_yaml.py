...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.show_datasets_from_yaml'
        db.add_column(u'web_competition', 'show_datasets_from_yaml',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.show_datasets_from_yaml'
        db.delete_column(u'web_competition', 'show_datasets_from_yaml')
