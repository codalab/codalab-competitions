...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Competition.sent_to_chahub'
        db.delete_column(u'web_competition', 'sent_to_chahub')

        # Adding field 'Competition.chahub_timestamp'
        db.add_column(u'web_competition', 'chahub_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Competition.chahub_needs_retry'
        db.add_column(u'web_competition', 'chahub_needs_retry',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Competition.sent_to_chahub'
        db.add_column(u'web_competition', 'sent_to_chahub',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Competition.chahub_timestamp'
        db.delete_column(u'web_competition', 'chahub_timestamp')

        # Deleting field 'Competition.chahub_needs_retry'
        db.delete_column(u'web_competition', 'chahub_needs_retry')
