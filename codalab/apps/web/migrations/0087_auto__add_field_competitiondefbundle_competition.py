...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionDefBundle.competition'
        db.add_column(u'web_competitiondefbundle', 'competition',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='bundle', unique=True, null=True, to=orm['web.Competition']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionDefBundle.competition'
        db.delete_column(u'web_competitiondefbundle', 'competition_id')
