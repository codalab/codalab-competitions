...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmission.is_public'
        db.add_column(u'web_competitionsubmission', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmission.is_public'
        db.delete_column(u'web_competitionsubmission', 'is_public')
