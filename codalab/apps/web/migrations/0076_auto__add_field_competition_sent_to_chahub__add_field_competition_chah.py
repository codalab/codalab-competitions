...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.chahub_data_hash'
        db.add_column(u'web_competition', 'chahub_data_hash',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Competition.chahub_data_hash'
        db.delete_column(u'web_competition', 'chahub_data_hash')
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'sent_to_chahub': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
