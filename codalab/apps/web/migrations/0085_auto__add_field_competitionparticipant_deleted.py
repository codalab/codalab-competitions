...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionParticipant.deleted'
        db.add_column(u'web_competitionparticipant', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionParticipant.deleted'
        db.delete_column(u'web_competitionparticipant', 'deleted')
