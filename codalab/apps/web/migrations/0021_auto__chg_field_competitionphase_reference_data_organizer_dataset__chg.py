...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.disallow_leaderboard_modifying'
        db.add_column(u'web_competition', 'disallow_leaderboard_modifying',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Competition.disallow_leaderboard_modifying'
        db.delete_column(u'web_competition', 'disallow_leaderboard_modifying')
