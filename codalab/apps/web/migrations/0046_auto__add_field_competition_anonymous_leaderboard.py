...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.anonymous_leaderboard'
        db.add_column(u'web_competition', 'anonymous_leaderboard',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.anonymous_leaderboard'
        db.delete_column(u'web_competition', 'anonymous_leaderboard')
