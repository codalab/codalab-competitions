...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.enable_single_competition_view'
        db.add_column(u'web_competition', 'enable_single_competition_view',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.enable_single_competition_view'
        db.delete_column(u'web_competition', 'enable_single_competition_view')
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'enable_single_competition_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
