...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionSubmissionMetadata.ingestion_program_duration'
        db.add_column(u'web_competitionsubmissionmetadata', 'ingestion_program_duration',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionSubmissionMetadata.ingestion_program_duration'
        db.delete_column(u'web_competitionsubmissionmetadata', 'ingestion_program_duration')
