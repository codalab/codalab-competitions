...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.original_yaml_file'
        db.add_column(u'web_competition', 'original_yaml_file',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.original_yaml_file'
        db.delete_column(u'web_competition', 'original_yaml_file')
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'original_yaml_file': ('django.db.models.fields.TextField', [], {'default': 'None'}),
