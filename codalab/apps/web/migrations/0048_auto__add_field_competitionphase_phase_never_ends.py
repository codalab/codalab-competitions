...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionPhase.phase_never_ends'
        db.add_column(u'web_competitionphase', 'phase_never_ends',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionPhase.phase_never_ends'
        db.delete_column(u'web_competitionphase', 'phase_never_ends')
