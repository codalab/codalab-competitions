...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.competition'
        db.add_column(u'web_page', 'competition',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='pages', null=True, to=orm['web.Competition']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.competition'
        db.delete_column(u'web_page', 'competition_id')
