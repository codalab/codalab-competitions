...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.allow_teams'
        db.add_column(u'web_competition', 'allow_teams',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.allow_teams'
        db.delete_column(u'web_competition', 'allow_teams')
