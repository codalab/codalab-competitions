...
urlpatterns = patterns(
    ...
    url(r'^competition/submission/(?P<submission_id>\d+)/(?P<filetype>stdout|stderr|output)\.(?P<ext>txt|zip)$', views.MyCompetitionSubmisisonOutput.as_view(),name='my_competition_output'),
