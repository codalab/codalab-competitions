...
urlpatterns = patterns(
    ...
    url(r'^competition/(?P<competition_id>\d+)/submissions/',
        ...
        name='my_competition_submissions'),
    url(r'^competition/submission/(?P<submission_id>\d+)/(?P<filetype>stdout.txt|stderr.txt|input.zip|'
        r'prediction-output.zip|output.zip|private_output.zip|detailed_results.html|predict_stdout.txt|'
        r'predict_stderr.txt)$',
