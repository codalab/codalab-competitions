...
e.isRootNode()&&0>=a)0==c?f(b):h(b);else if(!0===e.isLeafNode())0==c?g(b):n(b,e);else{var d=0;!1===e.isRootNode()&&(d=1);a=e.getChildren()[a-d];0==c?g(b,a):l(b,a)}}}};b.getMetadataTableModel=function(b){var d=[],a;for(a in b.metadata)("description"==a||"data_size"==a)&&b.metadata[a]&&d.push([a,b.metadata[a]]);"run"==b.bundle_type&&(d.push(["command",b.command]),d.push(["state",b.state]));return{tableDecorations:"bundle__meta_table",rowDecorations:"row",numRows:d.length,numCols:2,render:function(a,
b,h){0==b?h.setAttribute("class","col bundle__meta_type"):h.setAttribute("class","col");h.textContent=d[a][b]}}};b.getElementType=function(b,d){return void 0!==b?b:d};b.renderTable=function(e,d){var a=b.getElementType(d.tableElementType,"table"),c=b.getElementType(d.rowElementType,"tr"),f=b.getElementType(d.columnElementType,"td"),a=document.createElement(a);void 0!==d.tableDecorations&&a.setAttribute("class",d.tableDecorations);for(var h=0;h<d.numRows;h++){var g=document.createElement(c);if(0<d.numCols)for(var l=
0;l<d.numCols;l++){var k=document.createElement(f);d.render(h,l,k);g.appendChild(k)}else d.render(h,g);a.appendChild(g)}void 0!=e.firstChild&&e.removeChild(e.firstChild);e.appendChild(a)};b.prototype.render=function(e){var d=$(this.template.cloneNode(!0));d.find(".bundle-name").text(e.metadata.name);d.find(".bundle-icon-sm").removeClass("bundle-icon-sm").addClass("bundle-icon-sm--"+e.bundle_type+"--"+e.state);d.find(".bundle-uuid").text(e.uuid);d.find(".bundle-link").attr("href","/bundles/"+e.uuid);
d.find(".bundle-download").on("click",function(a){a.preventDefault();console.log(a);console.log(c.get(0));root=new BundleContentNode("/api/bundles/content",e.uuid);console.log(root)});var a=d.find(".bundle-meta-view-container").get(0);b.renderTable(a,b.getMetadataTableModel(e));var a=d.find(".bundle__expand_button"),c=d.find(".bundle-file-view-container");a.on("click",function(a){var d=$(a.target);if(d.hasClass("expanded"))c.removeClass("expanded"),c.children().removeClass("expanded"),d.removeClass("expanded"),
d.html('SHOW BUNDLE CONTENT<img src="/static/img/expand-arrow.png" alt="More">');else{if(void 0==c.get(0).firstChild){var g=new BundleContentNode("/api/bundles/content",e.uuid);b.loadContentAsync(c.get(0),g)}else c.children().addClass("expanded");c.addClass("expanded");d.addClass("expanded");d.html('HIDE BUNDLE CONTENT<img src="/static/img/expand-arrow.png" alt="Less">')}a.preventDefault()});return d.get(0)};return b}(),WorkshhetDirectiveRenderer=function(){return function(){var b=this;b.display=
"inline";b.bundleBlock=null;b.tableDirective=[];b.applyDirective=function(e,d){switch(d[1].directive){case "display":b.display=d[1].display;b.applyPendingDirectives(e);break;case "image":$(e).append($("<img />",{src:"/api/bundles/filecontent/"+b.bundleBlock.uuid+"/"+encodeURI(d[1].path),"class":"bundleImage",alt:d[1].name}));break;case "metadata":b.tableDirective.push(d[1])}};b.insertRowTable=function(b,d,a){var c=$("<tr></tr>");d.forEach(function(b){c.append($(a).text(b))});b.append(c)};b.getDataFromPath=
function(e){return b.bundleBlock.metadata[e]};b.applyPendingDirectives=function(e){if(0<b.tableDirective.length){var d=$("<table></table>");if("table"===b.display){var a=$("<thead></thead>");b.insertRowTable(a,b.tableDirective.map(function(a){return a.name}),"<th></th>")}var c=$("<tbody></tbody>");"table"===b.display?b.insertRowTable(c,b.tableDirective.map(function(a){return b.getDataFromPath(a.path)}),"<td></td>"):b.tableDirective.forEach(function(a){b.insertRowTable(c,[a.name,b.getDataFromPath(a.path)],
"<td></td>")});d.append(a);d.append(c);$(e).append(d);b.tableDirective=[]}}}}(),WorksheetRenderer=function(){return function(b,e,d){console.log("WorksheetRenderer");this.renderer=e;if(d&&d.items&&Array.isArray(d.items)){var a=this;e=d.name;var c=d.items.filter(function(a){return"title"===a[2]});0<c.length&&(e=markdown.toHTML("#"+c[0][1]).replace(/^<h1>/,"").replace(/<\/h1>$/,""));$(".worksheet-icon").html(e);$(".worksheet-author").html("by "+d.owner);var f=new WorkshhetDirectiveRenderer,h="";d.items.push([null,
"eof",null]);d.items.forEach(function(c,d,e){"directive"!=c[2]&&f.applyPendingDirectives(b);if("markup"!=c[2]&&0<h.length){var m=document.createElement("div");m.innerHTML=markdown.toHTML(h);b.appendChild(m);h=""}switch(c[2]){case "markup":h+=c[1]+"\n\r";break;case "bundle":b.appendChild(a.renderer.render(c[0]));break;case "directive":e.slice(d+1).forEach(function(a){"bundle"==a[2]&&(f.bundleBlock=a[0])}),f.applyDirective(b,c)}});MathJax.Hub.Queue(["Typeset",MathJax.Hub,b.id]);MathJax.Hub.Queue(function(){for(var a=
MathJax.Hub.getAllJax(),c=0;c<a.length;c+=1)$(a[c].SourceElement().parentNode).addClass("coda-jax")})}}}();var Competition;
...
success:function(b,c,d){console.log("Published competition.");$(a).children("#competition-publish-button").hide();$(a).children("#competition-delete-button").hide();$(a).children("#competition-unpublish-button").show()},error:function(a,b,c){a=$.parseJSON(a.responseJSON);a.error&&alert(a.error);console.log("Error publishing competition!")}})});$(this).children("#competition-unpublish-button").click(function(){});"True"==$(this)[0].getAttribute("published")?($(this).children("#competition-delete-button").hide(),
$(this).children("#competition-publish-button").hide(),$(this).children("#competition-unpublish-button").show()):($(this).children("#competition-delete-button").show(),$(this).children("#competition-publish-button").show(),$(this).children("#competition-unpublish-button").hide())});var a=window.location.href;void 0!==a&&(null!==a.match(/#participate-submit_results$/i)?b.invokePhaseButtonOnOpen("submissions_phase_buttons"):null!==a.match(/#results$/i)&&b.invokePhaseButtonOnOpen("results_phase_buttons"))})}})(Competition||
(Competition={}));var csrftoken;function csrfSafeMethod(b){return/^(GET|HEAD|OPTIONS|TRACE)$/.test(b)}function sameOrigin(b){var e="//"+document.location.host,d=document.location.protocol+e;return b==d||b.slice(0,d.length+1)==d+"/"||b==e||b.slice(0,e.length+1)==e+"/"||!/^(\/\/|http:|https:).*/.test(b)}$(function(){csrftoken=$.cookie("csrftoken");$.ajaxSetup({beforeSend:function(b,e){!csrfSafeMethod(e.type)&&sameOrigin(e.url)&&b.setRequestHeader("X-CSRFToken",csrftoken)}})});var CodaLab;
