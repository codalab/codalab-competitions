...
function(){return this.children};b.prototype.setChildren=function(b){this.children=b};b.prototype.getData=function(){return this.data};b.prototype.setData=function(b){this.data=b};return b}(),BundleRenderer=function(){function b(b){this.template=b}b.loadContentAsync=function(e,d){$.ajax({type:"GET",url:[d.getUrl(),d.getFullName()].join("/"),cache:!1,success:function(a){var c=[];Array.isArray(a)&&2==a.length&&(c=a[0].map(function(a){return new BundleContentNode(d.getUrl(),a,d)}),a=a[1].map(function(a){return new BundleContentNode(d.getUrl(),
a,d,null)}),c=c.concat(a).sort(function(a,c){return a.getName().localeCompare(c.getName())}));d.setChildren(c);b.renderTable(e,b.getContentTableModel(d,e))},error:function(a,c,b){}})};b.loadFileContentAsync=function(e,d){$.ajax({type:"GET",url:[d.getUrl().replace("api/bundles/content","api/bundles/filecontent"),d.getFullName()].join("/"),cache:!1,success:function(a){d.setData(a);b.renderTable(e,b.getContentTableModel(d,e))},error:function(a,c,b){}})};b.getContentTableModel=function(e,d){var a=0;!1==
e.isRootNode()&&(a+=1);if(e.isLeafNode())a+=1;else{var c=e.getChildren();void 0!==c&&(a+=c.length)}var f=function(a){a.setAttribute("class","col bundle__file_view__icon");var c=document.createElement("i");c.setAttribute("class","fi-arrow-left");a.appendChild(c);c.onclick=function(a){b.loadContentAsync(d,e.getParent());a.preventDefault()}},h=function(a){a.setAttribute("class","col bundle-item-type-goup");for(var c=[],f=e.getParent();void 0!==f;)c.push(f),f=f.getParent();c.reverse().forEach(function(c){var f=
document.createElement("a");f.textContent=c.getName();f.setAttribute("href","");f.onclick=function(a){b.loadContentAsync(d,c);a.preventDefault()};a.appendChild(f);a.appendChild(document.createTextNode(" / "))});a.appendChild(document.createTextNode(e.getName()))},g=function(a,c){a.setAttribute("class","col bundle__file_view__icon");var b=document.createElement("i");void 0!==c&&b.setAttribute("class",c.isLeafNode()?"fi-page":"fi-folder");a.appendChild(b)},l=function(a,c){if(c.isLeafNode()){a.setAttribute("class",
"col");var f=document.createElement("a");f.textContent=c.getName();f.setAttribute("href","");f.onclick=function(a){b.loadFileContentAsync(d,c);a.preventDefault()}}else a.setAttribute("class","col bundle-item-type-folder"),f=document.createElement("a"),f.textContent=c.getName(),f.setAttribute("href",""),f.onclick=function(a){b.loadContentAsync(d,c);a.preventDefault()};a.appendChild(f)},c=function(a,c){var b=document.createElement("img"),f=[c.getUrl().replace("api/bundles/content","api/bundles/filecontent"),
c.getFullName()].join("/");b.setAttribute("src",f);b.setAttribute("style","max-width:900px");return[b]},k=function(a,c){var b=document.createElement("iframe"),f=[c.getUrl().replace("api/bundles/content","api/bundles/filecontent"),c.getFullName()].join("/");b.setAttribute("src",f);b.setAttribute("style","width:100%; min-height:"+Math.max(200,Math.min(900,screen.height/2))+"px;");return[b]},m={txt:function(a,c){var b=document.createElement("pre");b.setAttribute("class","bundle__file_pre");b.textContent=
c.getData();return[b]},htm:k,html:k,jpg:c,png:c},n=function(a,c){var b=c.getName(),f="";0<b.indexOf(".")&&(f=b.toLowerCase().split(".").pop());b=m[f];void 0===b&&(b=m.txt);a.setAttribute("class","col");b(a,c).forEach(function(c){a.appendChild(c)})};return{tableDecorations:"bundle__file_view expanded",rowDecorations:"row",numRows:a,numCols:2,render:function(a,c,b){if(!1===e.isRootNode()&&0>=a)0==c?f(b):h(b);else if(!0===e.isLeafNode())0==c?g(b):n(b,e);else{var d=0;!1===e.isRootNode()&&(d=1);a=e.getChildren()[a-
d];0==c?g(b,a):l(b,a)}}}};b.getMetadataTableModel=function(b){var d=[],a;for(a in b.metadata)"name"!==a&&d.push([a,b.metadata[a]]);return{tableDecorations:"bundle__meta_table",rowDecorations:"row",numRows:d.length,numCols:2,render:function(a,b,h){0==b?h.setAttribute("class","col bundle__meta_type"):h.setAttribute("class","col");h.textContent=d[a][b]}}};b.getElementType=function(b,d){return void 0!==b?b:d};b.renderTable=function(e,d){var a=b.getElementType(d.tableElementType,"table"),c=b.getElementType(d.rowElementType,
"tr"),f=b.getElementType(d.columnElementType,"td"),a=document.createElement(a);void 0!==d.tableDecorations&&a.setAttribute("class",d.tableDecorations);for(var h=0;h<d.numRows;h++){var g=document.createElement(c);if(0<d.numCols)for(var l=0;l<d.numCols;l++){var k=document.createElement(f);d.render(h,l,k);g.appendChild(k)}else d.render(h,g);a.appendChild(g)}void 0!=e.firstChild&&e.removeChild(e.firstChild);e.appendChild(a)};b.prototype.render=function(e){var d=$(this.template.cloneNode(!0));d.find(".bundle-name").text(e.metadata.name);
d.find(".bundle-icon-sm").removeClass("bundle-icon-sm").addClass("bundle-icon-sm--"+e.bundle_type+"--"+e.state);d.find(".bundle-uuid").text(e.uuid);d.find(".bundle-link").attr("href","/bundles/"+e.uuid);d.find(".bundle-download").on("click",function(a){alert("This will allow you to download the bundle");a.preventDefault()});var a=d.find(".bundle-meta-view-container").get(0);b.renderTable(a,b.getMetadataTableModel(e));var a=d.find(".bundle__expand_button"),c=d.find(".bundle-file-view-container");a.on("click",
function(a){var d=$(a.target);if(d.hasClass("expanded"))c.removeClass("expanded"),c.children().removeClass("expanded"),d.removeClass("expanded"),d.html('SHOW BUNDLE CONTENT<img src="/static/img/expand-arrow.png" alt="More">');else{if(void 0==c.get(0).firstChild){var g=new BundleContentNode("/api/bundles/content",e.uuid);b.loadContentAsync(c.get(0),g)}else c.children().addClass("expanded");c.addClass("expanded");d.addClass("expanded");d.html('HIDE BUNDLE CONTENT<img src="/static/img/expand-arrow.png" alt="Less">')}a.preventDefault()});
return d.get(0)};return b}(),WorkshhetDirectiveRenderer=function(){return function(){var b=this;b.display="inline";b.bundleBlock=null;b.tableDirective=[];b.applyDirective=function(e,d){switch(d[1].directive){case "display":b.display=d[1].display;b.applyPendingDirectives(e);break;case "image":$(e).append($("<img />",{src:"/api/bundles/filecontent/"+b.bundleBlock.uuid+"/"+encodeURI(d[1].path),"class":"bundleImage",alt:d[1].name}));break;case "metadata":b.tableDirective.push(d[1])}};b.insertRowTable=
function(b,d,a){var c=$("<tr></tr>");d.forEach(function(b){c.append($(a).text(b))});b.append(c)};b.getDataFromPath=function(e){return b.bundleBlock.metadata[e]};b.applyPendingDirectives=function(e){if(0<b.tableDirective.length){var d=$("<table></table>");if("table"===b.display){var a=$("<thead></thead>");b.insertRowTable(a,b.tableDirective.map(function(a){return a.name}),"<th></th>")}var c=$("<tbody></tbody>");"table"===b.display?b.insertRowTable(c,b.tableDirective.map(function(a){return b.getDataFromPath(a.path)}),
"<td></td>"):b.tableDirective.forEach(function(a){b.insertRowTable(c,[a.name,b.getDataFromPath(a.path)],"<td></td>")});d.append(a);d.append(c);$(e).append(d);b.tableDirective=[]}}}}(),WorksheetRenderer=function(){return function(b,e,d){this.renderer=e;if(d&&d.items&&Array.isArray(d.items)){var a=this;e=d.name;var c=d.items.filter(function(a){return"title"===a[2]});0<c.length&&(e=markdown.toHTML("#"+c[0][1]).replace(/^<h1>/,"").replace(/<\/h1>$/,""));$(".worksheet-icon").html(e);$(".worksheet-author").html("by "+
d.owner);var f=new WorkshhetDirectiveRenderer,h="";d.items.push([null,"eof",null]);d.items.forEach(function(c,d,e){"directive"!=c[2]&&f.applyPendingDirectives(b);if("markup"!=c[2]&&0<h.length){var m=document.createElement("div");m.innerHTML=markdown.toHTML(h);b.appendChild(m);h=""}switch(c[2]){case "markup":h+=c[1]+"\n\r";break;case "bundle":c[1]&&b.appendChild(a.renderer.render(c[0]));break;case "directive":e.slice(d+1).forEach(function(a){"bundle"==a[2]&&(f.bundleBlock=a[0])}),f.applyDirective(b,
c)}});MathJax.Hub.Queue(["Typeset",MathJax.Hub,b.id]);MathJax.Hub.Queue(function(){for(var a=MathJax.Hub.getAllJax(),c=0;c<a.length;c+=1)$(a[c].SourceElement().parentNode).addClass("coda-jax")})}}}();var Competition;
(function(b){function e(a,c){c?(a.removeClass("leaderBoardSubmit"),a.addClass("leaderBoardRemove"),a.text("Remove from Leaderboard")):(a.removeClass("leaderBoardRemove"),a.addClass("leaderBoardSubmit"),a.text("Submit to Leaderboard"))}function d(a,c,b,d){a="/api/competition/"+a+"/submission/"+c+"/leaderboard";var g="delete";d.hasClass("leaderBoardSubmit")&&(g="post");request=$.ajax({url:a,type:g,datatype:"text",data:{csrfmiddlewaretoken:b},success:function(a,b,f){(a="post"==g)?(b=$("#user_results td.status"),
b.removeClass("submitted"),b.addClass("not_submitted"),b.html(""),b=$("#"+c+" td.status"),b.addClass("submitted"),b.html("<i class='fi-check'></i>"),$("#user_results button.leaderBoardRemove").each(function(a){e($(this),!1)})):(b=$("#"+c+" td.status"),b.removeClass("submitted"),b.addClass("not_submitted"),b.html(""));e(d,a)},error:function(a,b,c){alert("An error occurred. Please try again or report the issue")},beforeSend:function(a){a.setRequestHeader("X-CSRFToken",b)}})}b.invokePhaseButtonOnOpen=
function(a){var b=$("#"+a+" .button.selected")[0];void 0===b&&(b=$("#"+a+" .button.active")[0],void 0===b&&(b=$("#"+a+" .button")[0]));b.click()};b.getPhaseSubmissions=function(a,c,f){$(".competition_submissions").html("").append("<div class='competitionPreloader'></div>").children().css({top:"200px",display:"block"});$.ajax({type:"GET",url:"/competitions/"+a+"/submissions/"+c,cache:!1,success:function(c){$(".competition_submissions").html("").append(c);!1===CodaLab.FileUploader.isSupported()?($("#fileUploadButton").addClass("disabled"),
...
$("#details").html("The files that you selected is too large. There is a 1GB size limit.")),$("#fileUploadButton").removeClass("disabled"))},uploadProgress:function(a,b,c){b=100*b/c;$("#details").html("Uploading file <em>"+a.name+"</em>: "+b.toFixed(0)+"% complete.")},uploadError:function(a){$("#details").html("There was an error uploading the file. Please try again.");$("#fileUploadButton").removeClass("disabled")},uploadSuccess:function(c,f){$("#details").html("Creating new submission...");$.ajax({url:"/api/competition/"+
a+"/submission",type:"post",cache:!1,data:{id:f,name:c.name,type:c.type,size:c.size}}).done(function(a){$("#details").html("");$("#user_results tr.noData").remove();$("#user_results").append(b.displayNewSubmission(a));$("#user_results #"+a.id+" .fi-plus").on("click",function(){b.showOrHideSubmissionDetails(this)});$("#fileUploadButton").removeClass("disabled");$("#user_results #"+a.id+" .fi-plus").click()}).fail(function(a){var b="An unexpected error occurred.";403==a.status&&(b=a.responseJSON.detail);
$("#details").html(b);$("#fileUploadButton").removeClass("disabled")})}});$("#user_results .fi-plus").on("click",function(){b.showOrHideSubmissionDetails(this)})},error:function(a,b,c){$(".competition_submissions").html("<div class='alert-error'>An error occurred. Please try refreshing the page.</div>")}})};b.getPhaseResults=function(a,b){$(".competition_results").html("").append("<div class='competitionPreloader'></div>").children().css({top:"200px",display:"block"});$.ajax({type:"GET",url:"/competitions/"+
a+"/results/"+b,cache:!1,success:function(a){$(".competition_results").html("").append(a);$(".column-selectable").click(function(a){a=$(this).closest("table");$(a).find(".column-selected").removeClass();$(this).addClass("column-selected");var b=$(this).attr("name");a=a.find("td").filter(function(){return $(this).attr("name")===b}).addClass("column-selected");if(0<a.length)for(var c=a.slice().sort(function(a,b){var c=parseInt($.text([$(a).find("span")]));isNaN(c)&&(c=1E5);var d=parseInt($.text([$(b).find("span")]));
isNaN(d)&&(d=1E5);return c-d}),f=a[0].parentNode.parentNode,c=c.map(function(){return this.parentNode.cloneNode(!0)}),d=0;d<c.length;d++)$(c[d]).find("td.row-position").text($(c[d]).find("td.column-selected span").text()),f.insertBefore(c[d],a[d].parentNode),f.removeChild(a[d].parentNode)})},error:function(a,b,c){$(".competition_results").html("<div class='alert-error'>An error occurred. Please try refreshing the page.</div>")}})};b.registationCanProceed=function(){!0===$("#checkbox").is(":checked")?
$("#participateButton").removeClass("disabledStatus"):$("#participateButton").addClass("disabledStatus")};b.displayRegistrationStatus=function(a){var b="";$.ajax({type:"GET",url:"/api/competition/"+a+"/mystatus/",cache:!1,success:function(a){console.log(a);"approved"==a.status?location.reload():"pending"==a.status?(b="<div class='participateInfoBlock pendingApproval'>",b+="<div class='infoStatusBar'></div>",b+="<div class='labelArea'>",b+="<label class='regApprovLabel'>Your request to participate in this challenge has been received and a decision is pending.</label>",
...
return b};b.displayNewSubmission=function(a){var c=$("#submission_details_template #submission_row_template tr").clone();$(c).attr("id",a.id.toString());$(c).addClass(b.oddOrEven(a.submission_number));$(c).children().each(function(c){switch(c){case 0:"finished"===a.status&&$(this).val("1");break;case 1:$(this).html(a.submission_number.toString());break;case 2:$(this).html(a.filename);break;case 3:var d=function(a){a=a.toString();1==a.length&&(a="0"+a);return a},e=new Date(a.submitted_at);c=$.datepicker.formatDate("mm/dd/yy",
e).toString();var l=e.getHours().toString(),k=d(e.getMinutes()),d=d(e.getSeconds());$(this).html(c+" "+l+":"+k+":"+d);break;case 4:$(this).html(b.getSubmissionStatus(a.status))}});return c};b.oddOrEven=function(a){return a&1?"odd":"even"};b.getSubmissionStatus=function(a){var b="Unknown";"submitting"===a?b="Submitting":"submitted"===a?b="Submitted":"running"===a?b="Running":"failed"===a?b="Failed":"cancelled"===a?b="Cancelled":"finished"===a&&(b="Finished");return b};b.showOrHideSubmissionDetails=
function(a){var c=$(a).parents("tr")[0];if($(a).hasClass("fi-minus"))$(a).removeClass("fi-minus"),$(a).addClass("fi-plus"),$(c).next("tr.trDetails").remove();else{$(a).removeClass("fi-plus");$(a).addClass("fi-minus");a=$("#submission_details_template .trDetails").clone();a.find(".tdDetails").attr("colspan",c.cells.length);a.find("a").each(function(a){$(this).attr("href",$(this).attr("href").replace("_",c.id))});var f=$("#phasestate").val(),h=$(c).find("input[name='state']").val();if(1==f&&1==h){var g=
a.find("button");g.removeClass("hide");var f=$(c).find(".status").hasClass("submitted"),l=$("#competitionId").val();e(g,f);g.on("click",function(){d(l,c.id,$("#cstoken").val(),g)})}else{f=$.trim($(c).find(".statusName").html());g=a.find("button").addClass("hide");if("Submitting"===f||"Submitted"===f||"Running"===f)g.removeClass("hide"),g.text("Refresh status"),g.on("click",function(){b.updateSubmissionStatus($("#competitionId").val(),c.id,this)});"Failed"!==f&&"Cancelled"!==f||a.find("a").removeClass("hide")}$(c).after(a)}};
b.updateSubmissionStatus=function(a,c,f){$(f).parents(".submission_details").find(".preloader-handler").append("<div class='competitionPreloader'></div>").children().css({top:"25px",display:"block"});$.ajax({type:"GET",url:"/api/competition/"+a+"/submission/"+c,cache:!1,success:function(e){$("#user_results #"+c).find(".statusName").html(b.getSubmissionStatus(e.status));if("finished"===e.status)$("#user_results #"+c+"input:hidden").val("1"),1==$("#phasestate").val()?($(f).addClass("leaderBoardSubmit"),
$(f).text("Submit to Leaderboard"),$(f).on("click",function(){d(a,c,$("#cstoken").val(),$(f))})):$(f).addClass("hide");else if("failed"===e.status||"cancelled"===e.status)$(f).addClass("hide"),$(f).parent().parent().find("a").removeClass("hide");$(".competitionPreloader").hide()},error:function(a,b,c){}})};b.initialize=function(){$(document).ready(function(){$("#participate_form").submit(function(a){a.preventDefault();if($("#participateButton").hasClass("disabledStatus"))return!1;$("#result").html("");
a=$(this).serialize();var d=$("#competitionId").val();request=$.ajax({url:"/api/competition/"+d+"/participate/",type:"post",dataType:"text",data:a,success:function(a,c,e){$(".content form").replaceWith(b.displayRegistrationStatus(d))},error:function(a,b,c){alert("There was a problem registering for this competition.")}});return!1});$("#submissions_phase_buttons .button").each(function(a,d){$(this).click(function(){var a=$.trim($(this).attr("id").replace("submissions_phase_",""));$("#submissions_phase_buttons .button").removeClass("selected");
$(this).addClass("selected");var c=$("#competitionId").val(),d=$("#cstoken").val();b.getPhaseSubmissions(c,a,d)})});$("a[href='#participate-submit_results']").click(function(a){b.invokePhaseButtonOnOpen("submissions_phase_buttons")});$("#results_phase_buttons .button").each(function(a,d){$(this).click(function(){var a=$.trim($(this).attr("id").replace("results_phase_",""));$("#results_phase_buttons .button").removeClass("selected");$(this).addClass("selected");var c=$("#competitionId").val();b.getPhaseResults(c,
a)})});$("#Results").click(function(a){b.invokePhaseButtonOnOpen("results_phase_buttons")});$(this).foundation("section","reflow");$(".top-bar-section ul > li").removeClass("active");$("#liCompetitions").addClass("active");$(".my_managing .competition-tile #competition-actions").each(function(a,b){$(this).children("#competition-publish-button").click(function(){var a=$(this).parent()[0];request=$.ajax({url:$(this)[0].value,success:function(b,c,d){console.log("Published competition.");$(a).children("#competition-publish-button").hide();
$(a).children("#competition-delete-button").hide();$(a).children("#competition-unpublish-button").show()},error:function(a,b,c){console.log("Error publishing competition!")}})});$(this).children("#competition-unpublish-button").click(function(){});"True"==$(this)[0].getAttribute("published")?($(this).children("#competition-delete-button").hide(),$(this).children("#competition-publish-button").hide(),$(this).children("#competition-unpublish-button").show()):($(this).children("#competition-delete-button").show(),
$(this).children("#competition-publish-button").show(),$(this).children("#competition-unpublish-button").hide())});var a=window.location.href;void 0!==a&&(null!==a.match(/#participate-submit_results$/i)?b.invokePhaseButtonOnOpen("submissions_phase_buttons"):null!==a.match(/#results$/i)&&b.invokePhaseButtonOnOpen("results_phase_buttons"))})}})(Competition||(Competition={}));var csrftoken;function csrfSafeMethod(b){return/^(GET|HEAD|OPTIONS|TRACE)$/.test(b)}function sameOrigin(b){var e="//"+document.location.host,d=document.location.protocol+e;return b==d||b.slice(0,d.length+1)==d+"/"||b==e||b.slice(0,e.length+1)==e+"/"||!/^(\/\/|http:|https:).*/.test(b)}$(function(){csrftoken=$.cookie("csrftoken");$.ajaxSetup({beforeSend:function(b,e){!csrfSafeMethod(e.type)&&sameOrigin(e.url)&&b.setRequestHeader("X-CSRFToken",csrftoken)}})});var CodaLab;
...
b){$("#details").html("Creating competition... This may take a while. Please be patient.");$.ajax({url:"/api/competition/create",type:"post",cache:!1,data:{id:b,name:a.name,type:a.type,size:a.size}}).done(function(b){var a=function(){$.ajax({url:"/api/competition/create/"+b.token,type:"get",cache:!1,data:{csrfmiddlewaretoken:$("input[name='csrfmiddlewaretoken']").val()}}).done(function(b){"finished"==b.status?($("#details").html("Congratulations! Your new competition is ready to <a href='/competitions/"+
b.id+"'>view</a>. You can also manage it from <a href='/my/#manage'>your CodaLab dashboard.</a>"),$("#uploadButton").removeClass("disabled")):"failed"==b.status?($("#details").html("Oops! There was a problem creating the competition."),$("#uploadButton").removeClass("disabled")):setTimeout(a,1E3)}).fail(function(){$("#details").html("An unexpected error occurred.");$("#uploadButton").removeClass("disabled")})};a()}).fail(function(){$("#details").html("An unexpected error occurred.");$("#uploadButton").removeClass("disabled")})}})}})(b.Competitions||
...
controller:"worksheets"});e.html5Mode(!0);a.startSymbol("{[{");a.endSymbol("}]}")}]);angular.module("codalab.services").factory("worksheetsApi",["$http",function(b){var e=function(b,a,d,e){return b.data},d=function(b,a,d,e){throw b;},a=function(a){return function(){return b.get(a+"?preventCache="+Math.floor(1E3*Math.random())).then(e,d)}};return{info:a("/api/worksheets/info/"),worksheets:a("/api/worksheets/"),createWorksheet:function(a){return function(f){var h=$.cookie("csrftoken");!csrfSafeMethod("POST")&&sameOrigin(a)&&(b.defaults.headers.common["X-CSRFToken"]=h);return b.post(a,
f).then(e,d)}}("/api/worksheets/")}}]);angular.module("codalab.controllers").controller("root",["$scope","worksheetsApi",function(b,e){e.info().then(function(d){b.config=d.config;b.user=d.user})}]);angular.module("codalab.controllers").controller("worksheets",["$scope","$location","worksheetsApi",function(b,e,d){b.status="loading";b.selectionIndex=0;b.worksheets=[];b.statusMessage=function(a){var c={"":"",loading:"Loading worksheets...",loaderror:"Couldn't retrieve worksheets - Try refreshing the page",empty:"There are no worksheets.",saving:"Saving",saveerror:"Couldn't save - Try a different name"};switch(a){case "loaded":return 0<b.worksheets.length?"":c.empty}return c[a]};b.hasStatus=function(b){return b&&
0<b.length};d.worksheets().then(function(a){b.status="loaded";0===e.path().indexOf("/my")&&(a=a.filter(function(a){return a.owner===b.user.name}));angular.forEach(a,function(a){a.url="/worksheets/"+a.uuid;a.target="_self";a.editable=!1;var d=a.items.filter(function(a){return"title"==a.type});a.title=0<d.length?d[0].value:a.name;d=a.items.filter(function(a){return"overview"==a.type});0<d.length&&d.forEach(function(b){a.description=b.value+"\n"});b.worksheets.push(a)})},function(){b.status="loaderror"});
