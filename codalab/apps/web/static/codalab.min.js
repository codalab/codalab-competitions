...
function(){return this.children};c.prototype.setChildren=function(c){this.children=c};c.prototype.getData=function(){return this.data};c.prototype.setData=function(c){this.data=c};return c}(),BundleRenderer=function(){function c(c){this.template=c}c.loadContentAsync=function(e,d){console.log("loadContentAsync");$.ajax({type:"GET",url:[d.getUrl(),d.getFullName()].join("/"),cache:!1,success:function(a){console.log(a);console.log("");var b=[];Array.isArray(a)&&2==a.length&&(b=a[0].map(function(b){return new BundleContentNode(d.getUrl(),
b,d)}),a=a[1].map(function(b){return new BundleContentNode(d.getUrl(),b,d,null)}),b=b.concat(a).sort(function(b,a){return b.getName().localeCompare(a.getName())}));d.setChildren(b);c.renderTable(e,c.getContentTableModel(d,e))},error:function(a,b,c){}})};c.loadFileContentAsync=function(e,d){console.log("loadFileContentAsync");$.ajax({type:"GET",url:[d.getUrl().replace("api/bundles/content","api/bundles/filecontent"),d.getFullName()].join("/"),cache:!1,success:function(a){console.log(a);console.log("");
d.setData(a);c.renderTable(e,c.getContentTableModel(d,e))},error:function(a,b,c){}})};c.getContentTableModel=function(e,d){var a=0;!1===e.isRootNode()&&(a+=1);if(e.isLeafNode())a+=1;else{var b=e.getChildren();void 0!==b&&(a+=b.length)}var f=function(b){b.setAttribute("class","col bundle__file_view__icon");var a=document.createElement("i");a.setAttribute("class","fi-arrow-left");b.appendChild(a);a.onclick=function(b){c.loadContentAsync(d,e.getParent());b.preventDefault()}},h=function(b){b.setAttribute("class",
"col bundle-item-type-goup");for(var a=[],f=e.getParent();void 0!==f;)a.push(f),f=f.getParent();a.reverse().forEach(function(a){var f=document.createElement("a");f.textContent=a.getName();f.setAttribute("href","");f.onclick=function(b){c.loadContentAsync(d,a);b.preventDefault()};b.appendChild(f);b.appendChild(document.createTextNode(" / "))});b.appendChild(document.createTextNode(e.getName()))},g=function(b,a){b.setAttribute("class","col bundle__file_view__icon");var f=document.createElement("i");
void 0!==a&&f.setAttribute("class",a.isLeafNode()?"fi-page":"fi-folder");b.appendChild(f)},n=function(b,a){if(a.isLeafNode()){b.setAttribute("class","col");var f=document.createElement("a");f.textContent=a.getName();f.setAttribute("href","");f.onclick=function(b){c.loadFileContentAsync(d,a);b.preventDefault()}}else b.setAttribute("class","col bundle-item-type-folder"),f=document.createElement("a"),f.textContent=a.getName(),f.setAttribute("href",""),f.onclick=function(b){c.loadContentAsync(d,a);b.preventDefault()};
b.appendChild(f)},b=function(b,a){var f=document.createElement("img"),c=[a.getUrl().replace("api/bundles/content","api/bundles/filecontent"),a.getFullName()].join("/");f.setAttribute("src",c);f.setAttribute("style","max-width:900px");return[f]},l=function(b,a){var f=document.createElement("iframe"),c=[a.getUrl().replace("api/bundles/content","api/bundles/filecontent"),a.getFullName()].join("/");f.setAttribute("src",c);f.setAttribute("style","width:100%; min-height:"+Math.max(200,Math.min(900,screen.height/
2))+"px;");return[f]},m={txt:function(b,a){var f=document.createElement("pre");f.setAttribute("class","bundle__file_pre");f.textContent=a.getData();return[f]},htm:l,html:l,jpg:b,png:b},p=function(b,a){var f=a.getName(),c="";0<f.indexOf(".")&&(c=f.toLowerCase().split(".").pop());f=m[c];void 0===f&&(f=m.txt);b.setAttribute("class","col");f(b,a).forEach(function(a){b.appendChild(a)})};return{tableDecorations:"bundle__file_view expanded",rowDecorations:"row",numRows:a,numCols:2,render:function(b,a,c){if(!1===
e.isRootNode()&&0>=b)0==a?f(c):h(c);else if(!0===e.isLeafNode())0==a?g(c):p(c,e);else{var d=0;!1===e.isRootNode()&&(d=1);b=e.getChildren()[b-d];0==a?g(c,b):n(c,b)}}}};c.getMetadataTableModel=function(c){var d=[],a;for(a in c.metadata)console.log(a),"description"==a&&d.push([a,c.metadata[a]]);return{tableDecorations:"bundle__meta_table",rowDecorations:"row",numRows:d.length,numCols:2,render:function(b,a,c){0==a?c.setAttribute("class","col bundle__meta_type"):c.setAttribute("class","col");c.textContent=
d[b][a]}}};c.getElementType=function(c,d){return void 0!==c?c:d};c.renderTable=function(e,d){var a=c.getElementType(d.tableElementType,"table"),b=c.getElementType(d.rowElementType,"tr"),f=c.getElementType(d.columnElementType,"td"),a=document.createElement(a);void 0!==d.tableDecorations&&a.setAttribute("class",d.tableDecorations);for(var h=0;h<d.numRows;h++){var g=document.createElement(b);if(0<d.numCols)for(var n=0;n<d.numCols;n++){var l=document.createElement(f);d.render(h,n,l);g.appendChild(l)}else d.render(h,
...
e,d){this.renderer=e;if(d&&d.items&&Array.isArray(d.items)){var a=this;e=d.name;var b=d.items.filter(function(a){return"title"===a[2]});0<b.length&&(e=markdown.toHTML("#"+b[0][1]).replace(/^<h1>/,"").replace(/<\/h1>$/,""));$(".worksheet-icon").html(e);$(".worksheet-author").html("by "+d.owner);var f=new WorkshhetDirectiveRenderer,h="";d.items.push([null,"eof",null]);d.items.forEach(function(b,d,e){"directive"!=b[2]&&f.applyPendingDirectives(c);if("markup"!=b[2]&&0<h.length){var m=document.createElement("div");
m.innerHTML=markdown.toHTML(h);c.appendChild(m);h=""}switch(b[2]){case "markup":h+=b[1]+"\n\r";break;case "bundle":c.appendChild(a.renderer.render(b[0]));break;case "directive":e.slice(d+1).forEach(function(a){"bundle"==a[2]&&(f.bundleBlock=a[0])}),f.applyDirective(c,b)}});MathJax.Hub.Queue(["Typeset",MathJax.Hub,c.id]);MathJax.Hub.Queue(function(){for(var a=MathJax.Hub.getAllJax(),b=0;b<a.length;b+=1)$(a[b].SourceElement().parentNode).addClass("coda-jax")})}}}();var Competition;
...
c=$("#submission_method_description").val();return a&&""!==a&&b&&""!==b&&c&&""!==c},beforeSelection:function(a,b){$("#fileUploadButton").addClass("disabled")},afterSelection:function(a,b){!1===b&&(0<a.files.length&&("type-error"===a.files[0].errors[0].kind?$("#details").html("Please select a valid file. Only ZIP files are accepted."):$("#details").html("The files that you selected is too large. There is a 1GB size limit.")),$("#fileUploadButton").removeClass("disabled"))},uploadProgress:function(a,
b,c){b=100*b/c;$("#details").html("Uploading file <em>"+a.name+"</em>: "+b.toFixed(0)+"% complete.")},uploadError:function(a){$("#details").html("There was an error uploading the file. Please try again.");$("#fileUploadButton").removeClass("disabled")},uploadSuccess:function(b,f){$("#details").html("Creating new submission...");var d=$("#submission_description_textarea").val()||"",h=$("#submission_method_name").val()||"",e=$("#submission_method_description").val()||"",k=$("#submission_project_url").val()||
"",q=$("#submission_publication_url").val()||"",r=$("#submission_bibtex").val()||"",s=$("#submission_team_name").val()||"",t=$("#submission_organization_or_affiliation").val()||"";$("#submission_description_textarea").val("");$.ajax({url:"/api/competition/"+a+"/submission?description="+encodeURIComponent(d)+"&method_name="+encodeURIComponent(h)+"&method_description="+encodeURIComponent(e)+"&project_url="+encodeURIComponent(k)+"&publication_url="+encodeURIComponent(q)+"&team_name="+encodeURIComponent(s)+
"&organization_or_affiliation="+encodeURIComponent(t)+"&bibtex="+encodeURIComponent(r),type:"post",cache:!1,data:{id:f,name:b.name,type:b.type,size:b.size}}).done(function(a){$("#details").html("");$("#user_results tr.noData").remove();$("#user_results").append(c.displayNewSubmission(a,d,h,e,k,q,r,s,t));$("#user_results #"+a.id+" .glyphicon-plus").on("click",function(){c.showOrHideSubmissionDetails(this)});$("#fileUploadButton").removeClass("disabled");$("#user_results #"+a.id+" .glyphicon-plus").click()}).fail(function(a){var b=
"An unexpected error occurred.";403==a.status&&(b=a.responseJSON.detail);$("#details").html(b);$("#fileUploadButton").removeClass("disabled")})}});$("#user_results .glyphicon-plus").on("click",function(){c.showOrHideSubmissionDetails(this)})},error:function(a,b,c){$(".competition_submissions").html("<div class='alert alert-error'>An error occurred. Please try refreshing the page.</div>")}})};c.getPhaseResults=function(a,b){$(".competition_results").html("").append("<div class='competitionPreloader'></div>").children().css({top:"200px",
...
c.registationCanProceed=function(){!0===$("#checkbox").is(":checked")?$("#participateButton").removeClass("disabledStatus"):$("#participateButton").addClass("disabledStatus")};c.displayRegistrationStatus=function(a){var b="";$.ajax({type:"GET",url:"/api/competition/"+a+"/mystatus/",cache:!1,success:function(a){console.log(a);"approved"==a.status?location.reload():"pending"==a.status?(b="<div class='participateInfoBlock pendingApproval'>",b+="<div class='infoStatusBar'></div>",b+="<div class='labelArea'>",
b+="<label class='regApprovLabel'>Your request to participate in this challenge has been received and a decision is pending.</label>",b+="<label></label>",b+="</div>",b+="</div>"):"denied"==a.status&&(b="<div class='participateInfoBlock'>",b+="<div class='infoStatusBar'></div>",b+="<div class='labelArea'>",b+="<label class='regDeniedLabel'>Your request to participate in this challenge has been denied. The reason for your denied registrations is: "+a.reason+"</label>",b+="<label></label>",b+="</div>",
b+="</div>");location.reload()},error:function(a,b,c){$(".competition_results").html("<div class='alert - error'>An error occurred. Please try refreshing the page.</div>")}});return b};c.displayNewSubmission=function(a,b,f,d,e,n,l,m,p){var k=$("#submission_details_template #submission_row_template tr").clone();$(k).attr("id",a.id.toString());$(k).addClass(c.oddOrEven(a.submission_number));void 0!==b&&""!==b&&$(k).attr("data-description",b);void 0!==f&&""!==f&&$(k).attr("data-method-name",f);void 0!==
d&&""!==d&&$(k).attr("data-method-description",d);void 0!==e&&""!==e&&$(k).attr("data-project-url",e);void 0!==n&&""!==n&&$(k).attr("data-publication-url",n);void 0!==l&&""!==l&&$(k).attr("data-bibtex",l);void 0!==m&&""!==m&&$(k).attr("data-team-name",m);void 0!==p&&""!==p&&$(k).attr("data-organization-or-affiliation",p);$(k).children().each(function(b){switch(b){case 0:"finished"===a.status&&($(this).val("1"),0<$("#forced_to_leaderboard").length&&($(".glyphicon-ok").remove(),$($(k).children("td")[4]).html('<span class="glyphicon glyphicon-ok"></span>')));
break;case 1:$(this).html(a.submission_number.toString());break;case 2:$(this).html(a.filename);break;case 3:var f=function(a){a=a.toString();1==a.length&&(a="0"+a);return a},d=new Date(a.submitted_at);b=d.getDate().toString()+"/"+d.getMonth().toString()+"/"+d.getFullYear();var e=d.getHours().toString(),h=f(d.getMinutes()),f=f(d.getSeconds());$(this).html(b+" "+e+":"+h+":"+f);break;case 4:$(this).html(c.getSubmissionStatus(a.status))}});return k};c.oddOrEven=function(a){return a&1?"odd":"even"};c.getSubmissionStatus=
function(a){var b="Unknown";"submitting"===a?b="Submitting":"submitted"===a?b="Submitted":"running"===a?b="Running":"failed"===a?b="Failed":"cancelled"===a?b="Cancelled":"finished"===a&&(b="Finished");return b};c.showOrHideSubmissionDetails=function(a){var b=$(a).parents("tr")[0];if($(a).hasClass("glyphicon-minus"))$(a).removeClass("glyphicon-minus"),$(a).addClass("glyphicon-plus"),$(b).next("tr.trDetails").remove();else{$(a).removeClass("glyphicon-plus");$(a).addClass("glyphicon-minus");a=$("#submission_details_template .trDetails").clone();
...
$(b).attr("data-method-name"));$(b).attr("data-method-description")&&a.find(".submission_method_description").html("<b>Method description:</b><br><pre>"+$(b).attr("data-method-description")+"</pre>");$(b).attr("data-project-url")&&a.find(".submission_project_url").html('<b>Project URL:</b> <a href="'+$(b).attr("data-project-url")+'">'+$(b).attr("data-project-url")+"</a>");$(b).attr("data-publication-url")&&a.find(".submission_publication_url").html('<b>Publication URL:</b> <a href="'+$(b).attr("data-publication-url")+
'">'+$(b).attr("data-publication-url")+"</a>");$(b).attr("data-bibtex")&&a.find(".submission_bibtex").html("<b>Bibtex:</b><br><pre>"+$(b).attr("data-bibtex")+"</pre>");$(b).attr("data-organization-or-affiliation")&&a.find(".submission_organization_or_affiliation").html("<b>Organization/affiliation:</b> "+$(b).attr("data-organization-or-affiliation"));$(b).attr("data-exception")&&a.find(".traceback").html("Error: <br><pre>"+$(b).attr("data-exception")+"</pre>");var f=$("#phasestate").val(),h=$(b).find("input[name='state']").val();
if(1==f&&1==h){var g=a.find("button");g.removeClass("hide");var f=$(b).find(".status").hasClass("submitted"),n=$("#competitionId").val();e(g,f);g.on("click",function(){d(n,b.id,$("#cstoken").val(),g)})}else{f=$.trim($(b).find(".statusName").html());g=a.find("button").addClass("hide");if("Submitting"===f||"Submitted"===f||"Running"===f)g.removeClass("hide"),g.text("Refresh status"),g.on("click",function(){c.updateSubmissionStatus($("#competitionId").val(),b.id,this)});"Failed"!==f&&"Cancelled"!==f||
a.find("a").removeClass("hide")}$(b).after(a)}};c.updateSubmissionStatus=function(a,b,f){$(f).parents(".submission_details").find(".preloader-handler").append("<div class='competitionPreloader'></div>").children().css({top:"25px",display:"block"});$.ajax({type:"GET",url:"/api/competition/"+a+"/submission/"+b,cache:!1,success:function(e){$("#user_results #"+b).find(".statusName").html(c.getSubmissionStatus(e.status));if("finished"===e.status)$("#user_results #"+b+"input:hidden").val("1"),1==$("#phasestate").val()?
(0<$("#disallow_leaderboard_modifying").length?($(f).text("Leaderboard modifying disallowed").attr("disabled","disabled"),0<$("#forced_to_leaderboard").length&&($(".glyphicon-ok").remove(),$($("#"+b+" td")[4]).html('<span class="glyphicon glyphicon-ok"></span>'))):0==$("#forced_to_leaderboard").length?($(f).addClass("leaderBoardSubmit"),$(f).text("Submit to Leaderboard")):($(".glyphicon-ok").remove(),$($("#"+b+" td")[4]).html('<span class="glyphicon glyphicon-ok"></span>'),$(f).removeClass("leaderBoardSubmit"),
$(f).addClass("leaderBoardRemove"),$(f).text("Remove from Leaderboard")),$(f).unbind("click").off("click").on("click",function(){d(a,b,$("#cstoken").val(),$(f))})):$(f).addClass("hide");else if("failed"===e.status||"cancelled"===e.status)$(f).addClass("hide"),$(f).parent().parent().find("a").removeClass("hide"),e.exception_details&&$('a[href="traceback/'+b+'/"]').parent().html("Error: <br><pre>"+e.exception_details+"</pre>");$(".competitionPreloader").hide()},error:function(a,b,c){}})};c.initialize=
function(){$(document).ready(function(){$("#participate_form").submit(function(a){a.preventDefault();if($("#participateButton").hasClass("disabledStatus"))return!1;$("#result").html("");a=$(this).serialize();var b=$("#competitionId").val();request=$.ajax({url:"/api/competition/"+b+"/participate/",type:"post",dataType:"text",data:a,success:function(a,d,e){$(".content form").replaceWith(c.displayRegistrationStatus(b))},error:function(a,b,c){alert("There was a problem registering for this competition.")}});
return!1});$("#submissions_phase_buttons .btn").each(function(a,b){$(this).click(function(){var a=$.trim($(this).attr("id").replace("submissions_phase_",""));$("#submissions_phase_buttons .btn").removeClass("selected");$(this).addClass("selected");var b=$("#competitionId").val(),d=$("#cstoken").val();c.getPhaseSubmissions(b,a,d)})});$("#results_phase_buttons .btn").each(function(a,b){$(this).click(function(){var a=$.trim($(this).attr("id").replace("results_phase_",""));$("#results_phase_buttons .btn").removeClass("selected");
$(this).addClass("selected");var b=$("#competitionId").val();c.getPhaseResults(b,a)})});$(".top-bar-section ul > li").removeClass("active");$("#liCompetitions").addClass("active");$("#competition-publish-button").click(function(a){a.preventDefault();var b=$(this).parent()[0];request=$.ajax({url:$(this).attr("href"),success:function(a,c,d){console.log("Published competition.");$(b).children("#competition-publish-button").hide();$(b).children("#competition-delete-button").hide();$(b).children("#competition-unpublish-button").show()},
error:function(a,b,c){a=$.parseJSON(a.responseJSON);a.error&&alert(a.error);console.log("Error publishing competition!")}})});$("#competition-unpublish-button").click(function(a){a.preventDefault();var b=$(this).parent()[0];request=$.ajax({url:$(this).attr("href"),success:function(a,c,d){console.log("Unpublished competition.");$(b).children("#competition-publish-button").show();$(b).children("#competition-delete-button").show();$(b).children("#competition-unpublish-button").hide()},error:function(a,
b,c){console.log("Error unpublishing competition!")}})});$("#my_managing .competition-tile .competition-actions").each(function(a,b){"True"==$(this)[0].getAttribute("published")?($(this).find("#competition-delete-button").hide(),$(this).find("#competition-publish-button").hide(),$(this).find("#competition-unpublish-button").show()):($(this).find("#competition-delete-button").show(),$(this).find("#competition-publish-button").show(),$(this).find("#competition-unpublish-button").hide())})})}})(Competition||
(Competition={}));var csrftoken;function csrfSafeMethod(c){return/^(GET|HEAD|OPTIONS|TRACE)$/.test(c)}function sameOrigin(c){var e="//"+document.location.host,d=document.location.protocol+e;return c==d||c.slice(0,d.length+1)==d+"/"||c==e||c.slice(0,e.length+1)==e+"/"||!/^(\/\/|http:|https:).*/.test(c)}$(function(){csrftoken=$.cookie("csrftoken");$.ajaxSetup({beforeSend:function(c,e){!csrfSafeMethod(e.type)&&sameOrigin(e.url)&&c.setRequestHeader("X-CSRFToken",csrftoken)}})});var CodaLab;
(function(c){var e=function(){function c(a){var b=this;this.defaultOptions={buttonId:"fileUploadButton",disabledClassName:"disabled",validateBeforeFilePrompt:function(){return!0},beforeSelection:function(){},afterSelection:function(a,b){},uploadProgress:function(a,b,c){},uploadSuccess:function(a){},uploadError:function(a){},allowedFileTypes:void 0,extensionToFileType:{zip:"application/zip"},maxFileSizeInBytes:void 0,maxBlockSizeInBytes:1048576};this.options=$.extend({},this.defaultOptions,a);var f=
$("#"+this.options.buttonId);this.setupFileInput();f.after(this.fileInput);f.on("click",function(a){f.hasClass(b.options.disabledClassName)||(b.options.validateBeforeFilePrompt()?b.fileInput.click():alert("Please fill in all required fields first!"))})}c.prototype.setupFileInput=function(){var a=this,b=this.fileInput;this.fileInput=$(document.createElement("input"));this.fileInput.attr("type","file");this.fileInput.attr("style","visibility: hidden; width: 1px; height: 1px;");this.fileInput.on("change",
function(b){a.options.beforeSelection();b=a.validate();var e=0<b.files.length&&!0===c.selectionIsValid(b);a.options.afterSelection(b,e);e?a.beginUpload(b,0):a.setupFileInput()});void 0!==b&&b.replaceWith(this.fileInput)};c.prototype.validate=function(){var a=this,b=this.fileInput.get(0).files,c=[];0<b.length&&$.each(b,function(b,d){var e=[];a.options.maxFileSizeInBytes&&d.size>a.options.maxFileSizeInBytes&&e.push({kind:"size-error"});var l=d.type;if(""===l){var m=d.name.split(".");1<m.length&&(l=
a.options.extensionToFileType[m.pop().toLowerCase()])}a.options.allowedFileTypes&&-1===$.inArray(l,a.options.allowedFileTypes)&&e.push({kind:"type-error"});c.push({file:d,errors:e})});return{files:c}};c.selectionIsValid=function(a){return 0===a.files.map(function(a){return a.errors.length}).reduce(function(a,c,d,e){return a+c},0)};c.prototype.getCurrentFile=function(){if(void 0!==this.state)return this.state.selection.files[this.state.fileIndex].file};c.prototype.getFileReader=function(){var a=this,
