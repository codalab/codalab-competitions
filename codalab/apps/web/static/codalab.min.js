...
a.reason+"</label>",b+="<label></label>",b+="</div>",b+="</div>");location.reload()},error:function(a,b,c){$(".competition_results").html("<div class='alert - error'>An error occurred. Please try refreshing the page.</div>")}});return b};c.displayNewSubmission=function(a,b,f,d,e,m,l){var h=$("#submission_details_template #submission_row_template tr").clone();$(h).attr("id",a.id.toString());$(h).addClass(c.oddOrEven(a.submission_number));b&&$(h).attr("data-description",$(b).text());f&&$(h).attr("data-method-name",
$(f).text());d&&$(h).attr("data-method-description",$(d).text());e&&$(h).attr("data-project-url",$(e).text());m&&$(h).attr("data-publication-url",$(m).text());l&&$(h).attr("data-bibtex",$(l).text());$(h).children().each(function(b){switch(b){case 0:"finished"===a.status&&($(this).val("1"),0<$("#forced_to_leaderboard").length&&($(".glyphicon-ok").remove(),$($(h).children("td")[4]).html('<span class="glyphicon glyphicon-ok"></span>')));break;case 1:$(this).html(a.submission_number.toString());break;
case 2:$(this).html(a.filename);break;case 3:var f=function(a){a=a.toString();1==a.length&&(a="0"+a);return a},d=new Date(a.submitted_at);b=d.getDate().toString()+"/"+d.getMonth().toString()+"/"+d.getFullYear();var e=d.getHours().toString(),k=f(d.getMinutes()),f=f(d.getSeconds());$(this).html(b+" "+e+":"+k+":"+f);break;case 4:$(this).html(c.getSubmissionStatus(a.status))}});return h};c.oddOrEven=function(a){return a&1?"odd":"even"};c.getSubmissionStatus=function(a){var b="Unknown";"submitting"===
...
a.find(".tdDetails").attr("colspan",b.cells.length);a.find("a").each(function(a){$(this).attr("href",$(this).attr("href").replace("_",b.id))});$(b).attr("data-description")&&a.find(".submission_description").html("<b>Description:</b> <br><pre>"+$(b).attr("data-description")+"</pre>");$(b).attr("data-method-name")&&a.find(".submission_method_name").html("<b>Method name:</b> "+$(b).attr("data-method-name"));$(b).attr("data-method-description")&&a.find(".submission_method_description").html("<b>Method description:</b><br><pre>"+
$(b).attr("data-method-description")+"</pre>");$(b).attr("data-project-url")&&a.find(".submission_project_url").html('<b>Project URL:</b> <a href="'+$(b).attr("data-project-url")+'">'+$(b).attr("data-project-url")+"</a>");$(b).attr("data-publication-url")&&a.find(".submission_publication_url").html('<b>Publication URL:</b> <a href="'+$(b).attr("data-publication-url")+'">'+$(b).attr("data-publication-url")+"</a>");$(b).attr("data-bibtex")&&a.find(".submission_bibtex").html("<b>Bibtex:</b><br><pre>"+
$(b).attr("data-bibtex")+"</pre>");$(b).attr("data-exception")&&a.find(".traceback").html("Error: <br><pre>"+$(b).attr("data-exception")+"</pre>");var f=$("#phasestate").val(),k=$(b).find("input[name='state']").val();if(1==f&&1==k){var g=a.find("button");g.removeClass("hide");var f=$(b).find(".status").hasClass("submitted"),m=$("#competitionId").val();e(g,f);g.on("click",function(){d(m,b.id,$("#cstoken").val(),g)})}else{f=$.trim($(b).find(".statusName").html());g=a.find("button").addClass("hide");
