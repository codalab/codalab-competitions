...
a.getFullName()].join("/");d.setAttribute("src",c);d.setAttribute("style","max-width:900px");return[d]},k=function(b,d){var a=document.createElement("iframe"),c=[d.getUrl().replace("api/bundles/content","api/bundles/filecontent"),d.getFullName()].join("/");a.setAttribute("src",c);a.setAttribute("style","width:100%; min-height:"+Math.max(200,Math.min(900,screen.height/2))+"px;");return[a]},m={txt:function(b,a){var d=document.createElement("pre");d.setAttribute("class","bundle__file_pre");d.textContent=
a.getData();return[d]},htm:k,html:k,jpg:d,png:d},n=function(b,d){var a=d.getName(),c="";0<a.indexOf(".")&&(c=a.toLowerCase().split(".").pop());a=m[c];void 0===a&&(a=m.txt);b.setAttribute("class","col");a(b,d).forEach(function(a){b.appendChild(a)})};return{tableDecorations:"bundle__file_view expanded",rowDecorations:"row",numRows:b,numCols:2,render:function(b,a,d){if(!1===e.isRootNode()&&0>=b)0==a?f(d):h(d);else if(!0===e.isLeafNode())0==a?g(d):n(d,e);else{var c=0;!1===e.isRootNode()&&(c=1);b=e.getChildren()[b-
c];0==a?g(d,b):l(d,b)}}}};a.getMetadataTableModel=function(a){var c=[],b;for(b in a.metadata)"name"!==b&&c.push([b,a.metadata[b]]);return{tableDecorations:"bundle__meta_table",rowDecorations:"row",numRows:c.length,numCols:2,render:function(b,a,h){0==a?h.setAttribute("class","col bundle__meta_type"):h.setAttribute("class","col");h.textContent=c[b][a]}}};a.getElementType=function(a,c){return void 0!==a?a:c};a.renderTable=function(e,c){var b=a.getElementType(c.tableElementType,"table"),d=a.getElementType(c.rowElementType,
...
"<td></td>"):a.tableDirective.forEach(function(b){a.insertRowTable(d,[b.name,a.getDataFromPath(b.path)],"<td></td>")});c.append(b);c.append(d);$(e).append(c);a.tableDirective=[]}}}}(),WorksheetRenderer=function(){return function(a,e,c){this.renderer=e;if(c&&c.items&&Array.isArray(c.items)){var b=this;e=c.name;var d=c.items.filter(function(b){return"title"===b[2]});0<d.length&&(e=markdown.toHTML("#"+d[0][1]).replace(/^<h1>/,"").replace(/<\/h1>$/,""));$(".worksheet-icon").html(e);$(".worksheet-author").html("by "+
c.owner);var f=new WorkshhetDirectiveRenderer,h="";c.items.push([null,"eof",null]);c.items.forEach(function(d,c,e){"directive"!=d[2]&&f.applyPendingDirectives(a);if("markup"!=d[2]&&0<h.length){var m=document.createElement("div");m.innerHTML=markdown.toHTML(h);a.appendChild(m);h=""}switch(d[2]){case "markup":h+=d[1]+"\n\r";break;case "bundle":d[1]&&a.appendChild(b.renderer.render(d[0]));break;case "directive":e.slice(c+1).forEach(function(b){"bundle"==b[2]&&(f.bundleBlock=b[0])}),f.applyDirective(a,
d)}});MathJax.Hub.Queue(["Typeset",MathJax.Hub,a.id]);MathJax.Hub.Queue(function(){for(var b=MathJax.Hub.getAllJax(),a=0;a<b.length;a+=1)$(b[a].SourceElement().parentNode).addClass("coda-jax")})}}}();var Competition;
(function(a){function e(b,a){a?(b.removeClass("leaderBoardSubmit"),b.addClass("leaderBoardRemove"),b.text("Remove from Leaderboard")):(b.removeClass("leaderBoardRemove"),b.addClass("leaderBoardSubmit"),b.text("Submit to Leaderboard"))}function c(b,a,c,h){b="/api/competition/"+b+"/submission/"+a+"/leaderboard";var g="delete";h.hasClass("leaderBoardSubmit")&&(g="post");request=$.ajax({url:b,type:g,datatype:"text",data:{csrfmiddlewaretoken:c},success:function(b,c,f){(b="post"==g)?(c=$("#user_results td.status"),
c.removeClass("submitted"),c.addClass("not_submitted"),c.html(""),c=$("#"+a+" td.status"),c.addClass("submitted"),c.html("<i class='fi-check'></i>"),$("#user_results button.leaderBoardRemove").each(function(b){e($(this),!1)})):(c=$("#"+a+" td.status"),c.removeClass("submitted"),c.addClass("not_submitted"),c.html(""));e(h,b)},error:function(b,a,d){alert("An error occurred. Please try again or report the issue")},beforeSend:function(b){b.setRequestHeader("X-CSRFToken",c)}})}a.invokePhaseButtonOnOpen=
...
0<a.length};e.worksheets().then(function(c){a.status="loaded";angular.forEach(c,function(b){b.url="/worksheets/"+b.uuid;b.target="_self";b.editable=!1;var c=b.items.filter(function(a){return"title"==a.type});b.title=0<c.length?c[0].value:b.name;c=b.items.filter(function(a){return"overview"==a.type});0<c.length&&c.forEach(function(a){b.description=a.value+"\n"});a.worksheets.push(b)})},function(){a.status="loaderror"});a.saveWorksheet=function(a){a.status="saving";e.createWorksheet(a).then(function(b){a.uuid=
b.uuid;a.url="/worksheets/"+a.uuid;a.editable=!1;a.target="_self"},function(){a.status="saveerror"})};a.worksheetEnabled=function(a){return 0<a.name.length};a.addWorksheet=function(c,b){a.selectionIndex=c+(b?1:0);a.worksheets.splice(a.selectionIndex,0,{name:"",editable:!0,url:"#"})};a.keyPressed=function(c){if(c.ctrlKey)switch(c.keyCode){case 38:case 40:a.user.authenticated&&(a.addWorksheet(a.selectionIndex,40===c.keyCode),c.preventDefault())}else switch(c.keyCode){case 38:a.selectionIndex=0<a.selectionIndex?
a.selectionIndex-1:0;c.preventDefault();break;case 40:a.selectionIndex=a.selectionIndex<a.worksheets.length-1?a.selectionIndex+1:a.worksheets.length-1,c.preventDefault()}};a.gotFocus=function(c){a.selectionIndex=c};a.lostFocus=function(c){a.selectionIndex===c&&(a.selectionIndex=a.selectionIndex===a.worksheets.length-1?a.selectionIndex=a.worksheets.length:-1)}}]);angular.module("codalab.controllers").controller("worksheet",["$scope","worksheetsApi",function(a,e){a.status="Loading worksheet..."}]);angular.module("codalab.directives").directive("shortcut",function(){return{restrict:"E",replace:!0,scope:!0,link:function(a,e,c){var b=function(b){a.$apply(a.keyPressed(b))};$(document).on("keydown",b);a.$on("$destroy",function(){$(document).off("keydown",b)})}}});angular.module("codalab.directives").directive("setFocus",["$timeout",function(a){return{scope:{trigger:"@setFocus"},restrict:"A",link:function(e,c,b){b.$observe("setFocus",function(b){"true"===b&&document.activeElement!=c&&a(function(){"true"===e.trigger&&(c[0].focus(),e.trigger=!1)})})}}}]);angular.module("codalab.directives").directive("scrollIntoView",["$timeout",function(a){return{scope:{trigger:"@scrollIntoView"},restrict:"A",link:function(e,c,b){b.$observe("scrollIntoView",function(b,f){"true"===b&&b!==f&&a(function(){"true"===e.trigger&&(c[0].scrollIntoView(),e.trigger=!1)})})}}}]);//# sourceMappingURL=/static/codalab.min.map
