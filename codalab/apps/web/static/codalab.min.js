...
"BlockBlob")},success:function(a,d){var c=b.getCurrentFile();b.options.uploadProgress(c,b.state.bytesUploaded,c.size);b.state.bytesUploaded<c.size?b.upload():b.endUpload()},error:function(a,d,c){b.options.uploadError({kind:"write-error",jqXHR:a,file:b.getCurrentFile()})}})};a.onerror=function(a){b.options.uploadError({kind:"read-error",message:a.message,file:b.getCurrentFile()})};return a};a.prototype.beginUpload=function(a,d){this.state={sasUrl:void 0,sasVersion:void 0,trackingId:void 0,reader:void 0,
selection:a,fileIndex:d,blockIds:[],bytesUploaded:0};var c=this.getCurrentFile(),e=this;$.ajax({url:e.options.sasEndpoint,type:"POST",data:{name:c.name,type:c.type,size:c.size},success:function(a,b){e.state.sasUrl=a.url;e.state.sasVersion=a.version;e.state.trackingId=a.id;e.state.reader=e.getFileReader();e.options.uploadProgress(c,e.state.bytesUploaded,c.size);e.upload()},error:function(a,b,c){e.options.uploadError({kind:"sas-error",jqXHR:a,file:e.getCurrentFile()})}})};a.prototype.upload=function(){var a=
this.getCurrentFile(),c=this.state.bytesUploaded,e=c+Math.min(a.size-c,this.options.maxBlockSizeInBytes),a=a.slice(c,e),c="000000"+(this.state.blockIds.length+1),c=btoa(c.substring(c.length-6));this.state.blockIds.push(c);this.state.bytesUploaded=e;this.state.reader.readAsArrayBuffer(a)};a.prototype.endUpload=function(){var a=this.state.sasUrl+"&comp=blocklist",c=this.getCurrentFile(),e=['<?xml version="1.0" encoding="utf-8"?>'];e.push("<BlockList>");for(var h=0;h<this.state.blockIds.length;h++)e.push("  <Latest>"+
this.state.blockIds[h]+"</Latest>");e.push("</BlockList>");var g=this;$.ajax({url:a,type:"PUT",contentType:"application/xml",processData:!1,data:e.join("\n"),beforeSend:function(a){a.setRequestHeader("x-ms-version",g.state.sasVersion);a.setRequestHeader("x-ms-blob-content-type",c.type);a.setRequestHeader("x-ms-meta-name",c.name);a.setRequestHeader("x-ms-meta-size",c.size.toString())},success:function(a,b){g.options.uploadSuccess(c,g.state.trackingId);var e=1+g.state.fileIndex;e<g.state.selection.files.length?
g.beginUpload(g.state.selection,e):g.setupFileInput()},error:function(a,b,c){g.options.uploadError({kind:"write-error",jqXHR:a,file:g.getCurrentFile()})}})};a.isSupported=function(){return window.File&&window.FileReader&&window.FileList&&window.Blob?!0:!1};return a}();a.FileUploader=e;(function(a){a.CreateReady=function(){!1===e.isSupported()?($("#uploadButton").addClass("disabled"),$("#details").html("Sorry, your browser does not support the HTML5 File API. Please use a newer browser.")):new e({buttonId:"uploadButton",
