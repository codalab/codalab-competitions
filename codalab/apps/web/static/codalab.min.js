...
function(){return this.children};a.prototype.setChildren=function(a){this.children=a};a.prototype.getData=function(){return this.data};a.prototype.setData=function(a){this.data=a};return a}(),BundleRenderer=function(){function a(a){this.template=a}a.loadContentAsync=function(e,d){$.ajax({type:"GET",url:[d.getUrl(),d.getFullName()].join("/"),cache:!1,success:function(b){var c=[];Array.isArray(b)&&2==b.length&&(c=b[0].map(function(b){return new BundleContentNode(d.getUrl(),b,d)}),b=b[1].map(function(b){return new BundleContentNode(d.getUrl(),
b,d,null)}),c=c.concat(b).sort(function(b,c){return b.getName().localeCompare(c.getName())}));d.setChildren(c);a.renderTable(e,a.getContentTableModel(d,e))},error:function(b,c,a){}})};a.loadFileContentAsync=function(e,d){$.ajax({type:"GET",url:[d.getUrl().replace("api/bundles/content","api/bundles/filecontent"),d.getFullName()].join("/"),cache:!1,success:function(b){d.setData(b);a.renderTable(e,a.getContentTableModel(d,e))},error:function(b,c,a){}})};a.getContentTableModel=function(e,d){var b=0;!1==
e.isRootNode()&&(b+=1);if(e.isLeafNode())b+=1;else{var c=e.getChildren();void 0!==c&&(b+=c.length)}var f=function(b){b.setAttribute("class","col bundle__file_view__icon");var c=document.createElement("i");c.setAttribute("class","fi-arrow-left");b.appendChild(c);c.onclick=function(b){a.loadContentAsync(d,e.getParent());b.preventDefault()}},h=function(b){b.setAttribute("class","col bundle-item-type-goup");for(var c=[],f=e.getParent();void 0!==f;)c.push(f),f=f.getParent();c.reverse().forEach(function(c){var f=
document.createElement("a");f.textContent=c.getName();f.setAttribute("href","");f.onclick=function(b){a.loadContentAsync(d,c);b.preventDefault()};b.appendChild(f);b.appendChild(document.createTextNode(" / "))});b.appendChild(document.createTextNode(e.getName()))},g=function(b,c){b.setAttribute("class","col bundle__file_view__icon");var a=document.createElement("i");void 0!==c&&a.setAttribute("class",c.isLeafNode()?"fi-page":"fi-folder");b.appendChild(a)},l=function(b,c){if(c.isLeafNode()){b.setAttribute("class",
...
c.getFullName()].join("/");a.setAttribute("src",f);a.setAttribute("style","max-width:900px");return[a]},k=function(b,c){var a=document.createElement("iframe"),f=[c.getUrl().replace("api/bundles/content","api/bundles/filecontent"),c.getFullName()].join("/");a.setAttribute("src",f);a.setAttribute("style","width:100%; min-height:"+Math.max(200,Math.min(900,screen.height/2))+"px;");return[a]},m={txt:function(b,c){var a=document.createElement("pre");a.setAttribute("class","bundle__file_pre");a.textContent=
c.getData();return[a]},htm:k,html:k,jpg:c,png:c},n=function(b,c){var a=c.getName(),f="";0<a.indexOf(".")&&(f=a.toLowerCase().split(".").pop());a=m[f];void 0===a&&(a=m.txt);b.setAttribute("class","col");a(b,c).forEach(function(c){b.appendChild(c)})};return{tableDecorations:"bundle__file_view expanded",rowDecorations:"row",numRows:b,numCols:2,render:function(b,c,a){if(!1===e.isRootNode()&&0>=b)0==c?f(a):h(a);else if(!0===e.isLeafNode())0==c?g(a):n(a,e);else{var d=0;!1===e.isRootNode()&&(d=1);b=e.getChildren()[b-
d];0==c?g(a,b):l(a,b)}}}};a.getMetadataTableModel=function(a){var d=[],b;for(b in a.metadata)"name"!==b&&d.push([b,a.metadata[b]]);return{tableDecorations:"bundle__meta_table",rowDecorations:"row",numRows:d.length,numCols:2,render:function(b,a,h){0==a?h.setAttribute("class","col bundle__meta_type"):h.setAttribute("class","col");h.textContent=d[b][a]}}};a.getElementType=function(a,d){return void 0!==a?a:d};a.renderTable=function(e,d){var b=a.getElementType(d.tableElementType,"table"),c=a.getElementType(d.rowElementType,
"tr"),f=a.getElementType(d.columnElementType,"td"),b=document.createElement(b);void 0!==d.tableDecorations&&b.setAttribute("class",d.tableDecorations);for(var h=0;h<d.numRows;h++){var g=document.createElement(c);if(0<d.numCols)for(var l=0;l<d.numCols;l++){var k=document.createElement(f);d.render(h,l,k);g.appendChild(k)}else d.render(h,g);b.appendChild(g)}void 0!=e.firstChild&&e.removeChild(e.firstChild);e.appendChild(b)};a.prototype.render=function(e){var d=$(this.template.cloneNode(!0));d.find(".bundle-name").text(e.metadata.name);
d.find(".bundle-icon-sm").removeClass("bundle-icon-sm").addClass("bundle-icon-sm--"+e.bundle_type+"--"+e.state);d.find(".bundle-uuid").text(e.uuid);d.find(".bundle-link").attr("href","/bundles/"+e.uuid);d.find(".bundle-download").on("click",function(b){alert("This will allow you to download the bundle");b.preventDefault()});var b=d.find(".bundle-meta-view-container").get(0);a.renderTable(b,a.getMetadataTableModel(e));var b=d.find(".bundle__expand_button"),c=d.find(".bundle-file-view-container");b.on("click",
function(b){var d=$(b.target);if(d.hasClass("expanded"))c.removeClass("expanded"),c.children().removeClass("expanded"),d.removeClass("expanded"),d.html('SHOW BUNDLE CONTENT<img src="/static/img/expand-arrow.png" alt="More">');else{if(void 0==c.get(0).firstChild){var g=new BundleContentNode("/api/bundles/content",e.uuid);a.loadContentAsync(c.get(0),g)}else c.children().addClass("expanded");c.addClass("expanded");d.addClass("expanded");d.html('HIDE BUNDLE CONTENT<img src="/static/img/expand-arrow.png" alt="Less">')}b.preventDefault()});
return d.get(0)};return a}(),WorkshhetDirectiveRenderer=function(){return function(){var a=this;a.display="inline";a.bundleBlock=null;a.tableDirective=[];a.applyDirective=function(e,d){switch(d[1].directive){case "display":a.display=d[1].display;a.applyPendingDirectives(e);break;case "image":$(e).append($("<img />",{src:"/api/bundles/filecontent/"+a.bundleBlock.uuid+"/"+encodeURI(d[1].path),"class":"bundleImage",alt:d[1].name}));break;case "metadata":a.tableDirective.push(d[1])}};a.insertRowTable=
function(a,d,b){var c=$("<tr></tr>");d.forEach(function(a){c.append($(b).text(a))});a.append(c)};a.getDataFromPath=function(e){return a.bundleBlock.metadata[e]};a.applyPendingDirectives=function(e){if(0<a.tableDirective.length){var d=$("<table></table>");if("table"===a.display){var b=$("<thead></thead>");a.insertRowTable(b,a.tableDirective.map(function(b){return b.name}),"<th></th>")}var c=$("<tbody></tbody>");"table"===a.display?a.insertRowTable(c,a.tableDirective.map(function(b){return a.getDataFromPath(b.path)}),
"<td></td>"):a.tableDirective.forEach(function(b){a.insertRowTable(c,[b.name,a.getDataFromPath(b.path)],"<td></td>")});d.append(b);d.append(c);$(e).append(d);a.tableDirective=[]}}}}(),WorksheetRenderer=function(){return function(a,e,d){this.renderer=e;if(d&&d.items&&Array.isArray(d.items)){var b=this;e=d.name;var c=d.items.filter(function(b){return"title"===b[2]});0<c.length&&(e=markdown.toHTML("#"+c[0][1]).replace(/^<h1>/,"").replace(/<\/h1>$/,""));$(".worksheet-icon").html(e);$(".worksheet-author").html("by "+
d.owner);var f=new WorkshhetDirectiveRenderer,h="";d.items.push([null,"eof",null]);d.items.forEach(function(c,d,e){"directive"!=c[2]&&f.applyPendingDirectives(a);if("markup"!=c[2]&&0<h.length){var m=document.createElement("div");m.innerHTML=markdown.toHTML(h);a.appendChild(m);h=""}switch(c[2]){case "markup":h+=c[1]+"\n\r";break;case "bundle":c[1]&&a.appendChild(b.renderer.render(c[0]));break;case "directive":e.slice(d+1).forEach(function(b){"bundle"==b[2]&&(f.bundleBlock=b[0])}),f.applyDirective(a,
c)}});MathJax.Hub.Queue(["Typeset",MathJax.Hub,a.id]);MathJax.Hub.Queue(function(){for(var b=MathJax.Hub.getAllJax(),c=0;c<b.length;c+=1)$(b[c].SourceElement().parentNode).addClass("coda-jax")})}}}();var Competition;
(function(a){function e(b,c){c?(b.removeClass("leaderBoardSubmit"),b.addClass("leaderBoardRemove"),b.text("Remove from Leaderboard")):(b.removeClass("leaderBoardRemove"),b.addClass("leaderBoardSubmit"),b.text("Submit to Leaderboard"))}function d(b,c,a,d){b="/api/competition/"+b+"/submission/"+c+"/leaderboard";var g="delete";d.hasClass("leaderBoardSubmit")&&(g="post");request=$.ajax({url:b,type:g,datatype:"text",data:{csrfmiddlewaretoken:a},success:function(b,a,f){(b="post"==g)?(a=$("#user_results td.status"),
a.removeClass("submitted"),a.addClass("not_submitted"),a.html(""),a=$("#"+c+" td.status"),a.addClass("submitted"),a.html("<i class='fi-check'></i>"),$("#user_results button.leaderBoardRemove").each(function(b){e($(this),!1)})):(a=$("#"+c+" td.status"),a.removeClass("submitted"),a.addClass("not_submitted"),a.html(""));e(d,b)},error:function(b,a,c){alert("An error occurred. Please try again or report the issue")},beforeSend:function(b){b.setRequestHeader("X-CSRFToken",a)}})}a.invokePhaseButtonOnOpen=
function(b){var a=$("#"+b+" .button.selected")[0];void 0===a&&(a=$("#"+b+" .button.active")[0],void 0===a&&(a=$("#"+b+" .button")[0]));a.click()};a.getPhaseSubmissions=function(b,c,f){$(".competition_submissions").html("").append("<div class='competitionPreloader'></div>").children().css({top:"200px",display:"block"});$.ajax({type:"GET",url:"/competitions/"+b+"/submissions/"+c,cache:!1,success:function(c){$(".competition_submissions").html("").append(c);!1===CodaLab.FileUploader.isSupported()?($("#fileUploadButton").addClass("disabled"),
...
e).toString();var l=e.getHours().toString(),k=d(e.getMinutes()),d=d(e.getSeconds());$(this).html(c+" "+l+":"+k+":"+d);break;case 4:$(this).html(a.getSubmissionStatus(b.status))}});return c};a.oddOrEven=function(b){return b&1?"odd":"even"};a.getSubmissionStatus=function(b){var a="Unknown";"submitting"===b?a="Submitting":"submitted"===b?a="Submitted":"running"===b?a="Running":"failed"===b?a="Failed":"cancelled"===b?a="Cancelled":"finished"===b&&(a="Finished");return a};a.showOrHideSubmissionDetails=
...
b.find("button");g.removeClass("hide");var f=$(c).find(".status").hasClass("submitted"),l=$("#competitionId").val();e(g,f);g.on("click",function(){d(l,c.id,$("#cstoken").val(),g)})}else{f=$.trim($(c).find(".statusName").html());g=b.find("button").addClass("hide");if("Submitting"===f||"Submitted"===f||"Running"===f)g.removeClass("hide"),g.text("Refresh status"),g.on("click",function(){a.updateSubmissionStatus($("#competitionId").val(),c.id,this)});"Failed"!==f&&"Cancelled"!==f||b.find("a").removeClass("hide")}$(c).after(b)}};
