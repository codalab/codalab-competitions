...
success:function(b,c,d){console.log("Published competition.");$(a).children("#competition-publish-button").hide();$(a).children("#competition-delete-button").hide();$(a).children("#competition-unpublish-button").show()},error:function(a,b,c){var d=$.parseJSON(a.responseJSON);d.error&&alert(d.error);console.log("Error publishing competition!");console.log(a);console.log(b);console.log(c)}})});$(this).children("#competition-unpublish-button").click(function(){});"True"==$(this)[0].getAttribute("published")?
...
b.invokePhaseButtonOnOpen("results_phase_buttons"))})}})(Competition||(Competition={}));var csrftoken;function csrfSafeMethod(b){return/^(GET|HEAD|OPTIONS|TRACE)$/.test(b)}function sameOrigin(b){var e="//"+document.location.host,d=document.location.protocol+e;return b==d||b.slice(0,d.length+1)==d+"/"||b==e||b.slice(0,e.length+1)==e+"/"||!/^(\/\/|http:|https:).*/.test(b)}$(function(){csrftoken=$.cookie("csrftoken");$.ajaxSetup({beforeSend:function(b,e){!csrfSafeMethod(e.type)&&sameOrigin(e.url)&&b.setRequestHeader("X-CSRFToken",csrftoken)}})});var CodaLab;
