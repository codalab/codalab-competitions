...
uploadSuccess:function(b,f){$("#details").html("Creating new submission...");var d=$("#submission_description_textarea").val(),k=$("#submission_method_name").val(),e=$("#submission_method_description").val(),n=$("#submission_project_url").val(),p=$("#submission_publication_url").val(),q=$("#submission_bibtex").val();$("#submission_description_textarea").val("");$.ajax({url:"/api/competition/"+a+"/submission?description="+encodeURIComponent(d)+"&method_name="+encodeURIComponent(k)+"&method_description="+
encodeURIComponent(e)+"&project_url="+encodeURIComponent(n)+"&publication_url="+encodeURIComponent(p)+"&bibtex="+encodeURIComponent(q),type:"post",cache:!1,data:{id:f,name:b.name,type:b.type,size:b.size}}).done(function(a){$("#details").html("");$("#user_results tr.noData").remove();$("#user_results").append(c.displayNewSubmission(a,d,k,e,n,p,q));$("#user_results #"+a.id+" .glyphicon-plus").on("click",function(){c.showOrHideSubmissionDetails(this)});$("#fileUploadButton").removeClass("disabled");
