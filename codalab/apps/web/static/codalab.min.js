...
$(f).text("Automatically submitted to leaderboard").attr("disabled","disabled"):($(f).addClass("leaderBoardSubmit"),$(f).text("Submit to Leaderboard"),$(f).on("click",function(){d(a,c,$("#cstoken").val(),$(f))})):$(f).addClass("hide");else if("failed"===e.status||"cancelled"===e.status)$(f).addClass("hide"),$(f).parent().parent().find("a").removeClass("hide");$(".competitionPreloader").hide()},error:function(a,b,c){}})};b.initialize=function(){$(document).ready(function(){$("#participate_form").submit(function(a){a.preventDefault();
if($("#participateButton").hasClass("disabledStatus"))return!1;$("#result").html("");a=$(this).serialize();var d=$("#competitionId").val();request=$.ajax({url:"/api/competition/"+d+"/participate/",type:"post",dataType:"text",data:a,success:function(a,c,e){$(".content form").replaceWith(b.displayRegistrationStatus(d))},error:function(a,b,c){alert("There was a problem registering for this competition.")}});return!1});$("#submissions_phase_buttons .button").each(function(a,d){$(this).click(function(){var a=
$.trim($(this).attr("id").replace("submissions_phase_",""));$("#submissions_phase_buttons .button").removeClass("selected");$(this).addClass("selected");var c=$("#competitionId").val(),d=$("#cstoken").val();b.getPhaseSubmissions(c,a,d)})});$("a[href='#participate-submit_results']").click(function(a){b.invokePhaseButtonOnOpen("submissions_phase_buttons")});$("#results_phase_buttons .button").each(function(a,d){$(this).click(function(){var a=$.trim($(this).attr("id").replace("results_phase_",""));$("#results_phase_buttons .button").removeClass("selected");
$(this).addClass("selected");var c=$("#competitionId").val();b.getPhaseResults(c,a)})});$("#Results").click(function(a){b.invokePhaseButtonOnOpen("results_phase_buttons")});$(this).foundation("section","reflow");$(".top-bar-section ul > li").removeClass("active");$("#liCompetitions").addClass("active");$(".my_managing .competition-tile #competition-actions").each(function(a,b){$(this).children("#competition-publish-button").click(function(){var a=$(this).parent()[0];request=$.ajax({url:$(this)[0].value,
success:function(b,c,d){console.log("Published competition.");$(a).children("#competition-publish-button").hide();$(a).children("#competition-delete-button").hide();$(a).children("#competition-unpublish-button").show()},error:function(a,b,c){console.log("Error publishing competition!")}})});$(this).children("#competition-unpublish-button").click(function(){});"True"==$(this)[0].getAttribute("published")?($(this).children("#competition-delete-button").hide(),$(this).children("#competition-publish-button").hide(),
$(this).children("#competition-unpublish-button").show()):($(this).children("#competition-delete-button").show(),$(this).children("#competition-publish-button").show(),$(this).children("#competition-unpublish-button").hide())});var a=window.location.href;void 0!==a&&(null!==a.match(/#participate-submit_results$/i)?b.invokePhaseButtonOnOpen("submissions_phase_buttons"):null!==a.match(/#results$/i)&&b.invokePhaseButtonOnOpen("results_phase_buttons"))})}})(Competition||(Competition={}));var csrftoken;function csrfSafeMethod(b){return/^(GET|HEAD|OPTIONS|TRACE)$/.test(b)}function sameOrigin(b){var e="//"+document.location.host,d=document.location.protocol+e;return b==d||b.slice(0,d.length+1)==d+"/"||b==e||b.slice(0,e.length+1)==e+"/"||!/^(\/\/|http:|https:).*/.test(b)}$(function(){csrftoken=$.cookie("csrftoken");$.ajaxSetup({beforeSend:function(b,e){!csrfSafeMethod(e.type)&&sameOrigin(e.url)&&b.setRequestHeader("X-CSRFToken",csrftoken)}})});var CodaLab;
