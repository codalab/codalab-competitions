...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClUser.allow_forum_notifications'
        db.add_column(u'authenz_cluser', 'allow_forum_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClUser.allow_forum_notifications'
        db.delete_column(u'authenz_cluser', 'allow_forum_notifications')
