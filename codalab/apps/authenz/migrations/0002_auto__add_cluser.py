...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(m2m_table_name, ['cluser_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'authenz_cluser')

        # Removing M2M table for field groups on 'ClUser'
        db.delete_table(db.shorten_name(u'authenz_cluser_groups'))
