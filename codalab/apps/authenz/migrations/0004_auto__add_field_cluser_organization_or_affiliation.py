...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClUser.organization_or_affiliation'
        db.add_column(u'authenz_cluser', 'organization_or_affiliation',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClUser.organization_or_affiliation'
        db.delete_column(u'authenz_cluser', 'organization_or_affiliation')
