...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ClUser', fields ['username']
        db.create_index(u'authenz_cluser', ['username'])


    def backwards(self, orm):
        # Removing index on 'ClUser', fields ['username']
        db.delete_index(u'authenz_cluser', ['username'])
