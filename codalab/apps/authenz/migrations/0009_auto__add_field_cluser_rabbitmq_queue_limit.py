...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClUser.rabbitmq_queue_limit'
        db.add_column(u'authenz_cluser', 'rabbitmq_queue_limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClUser.rabbitmq_queue_limit'
        db.delete_column(u'authenz_cluser', 'rabbitmq_queue_limit')
