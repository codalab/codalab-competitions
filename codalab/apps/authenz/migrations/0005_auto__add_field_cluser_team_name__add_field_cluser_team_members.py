...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClUser.team_name'
        db.add_column(u'authenz_cluser', 'team_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClUser.team_members'
        db.add_column(u'authenz_cluser', 'team_members',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClUser.team_name'
        db.delete_column(u'authenz_cluser', 'team_name')

        # Deleting field 'ClUser.team_members'
        db.delete_column(u'authenz_cluser', 'team_members')
