...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'coopetitions_downloadrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='downloads', to=orm['web.CompetitionSubmission'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authenz.ClUser'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'coopetitions', ['DownloadRecord'])

        # Adding unique constraint on 'DownloadRecord', fields ['submission', 'user']
        db.create_unique(u'coopetitions_downloadrecord', ['submission_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DownloadRecord', fields ['submission', 'user']
        db.delete_unique(u'coopetitions_downloadrecord', ['submission_id', 'user_id'])

        # Deleting model 'DownloadRecord'
        db.delete_table(u'coopetitions_downloadrecord')
    ...
    models = {
        ...
        u'coopetitions.downloadrecord': {
            'Meta': {'unique_together': "(('submission', 'user'),)", 'object_name': 'DownloadRecord'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'downloads'", 'to': u"orm['web.CompetitionSubmission']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authenz.ClUser']"})
        },
        u'coopetitions.like': {
