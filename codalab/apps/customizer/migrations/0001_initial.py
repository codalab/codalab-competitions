...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'customizer_configuration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('header_logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('only_competition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Competition'], null=True, blank=True)),
        ))
        db.send_create_signal(u'customizer', ['Configuration'])


    def backwards(self, orm):
        # Deleting model 'Configuration'
        db.delete_table(u'customizer_configuration')
