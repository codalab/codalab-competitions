...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forums_forum', (
            ...
            ('competition', self.gf('django.db.models.fields.related.OneToOneField')(related_name='forum', unique=True, to=orm['web.Competition'])),
        ))
        ...
        db.create_table(u'forums_thread', (
            ...
            ('started_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authenz.ClUser'])),
        ...
        db.create_table(u'forums_post', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', to=orm['forums.Thread'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')()),
            ('posted_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authenz.ClUser'])),
