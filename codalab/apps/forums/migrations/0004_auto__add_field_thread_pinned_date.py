...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thread.pinned_date'
        db.add_column(u'forums_thread', 'pinned_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thread.pinned_date'
        db.delete_column(u'forums_thread', 'pinned_date')
    ...
    models = {
        ...
        u'forums.thread': {
            'Meta': {'ordering': "('-last_post_date',)", 'object_name': 'Thread'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'pinned_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
